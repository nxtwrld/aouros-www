...
export class MedicalMCPServer extends MCPServer {
      ...
      tools: [
        ...
        // Medical Coding Tools
        {
          ...
          inputSchema: {
            ...
            properties: {
              code: { type: "string" },
              codeSystem: { type: "string", enum: ["ICD10", "ICD11", "SNOMED"] },
              description: { type: "string" },
              language: { type: "string", enum: ["en", "cs", "de", "fr", "es"] }
            },
        ...
        
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              sourceSystem: { type: "string", enum: ["SNOMED", "ICD10", "ICD11"] },
              targetSystem: { type: "string", enum: ["SNOMED", "ICD10", "ICD11"] },
              mapType: { type: "string", enum: ["exact", "approximate", "broader", "narrower"] }
            },
  ...
  private async validateDiagnosisCode(args: any) {
    ...
    switch (codeSystem.toLowerCase()) {
      ...
      case 'icd11':
        ...
        break;
      case 'snomed':
        validationResult = await this.codingTools.validateSNOMED(code, language);
        break;
      default:
  ...
  private async searchSnomedConcepts(args: any) {
    ...
    return { content: [{ type: "text", text: JSON.stringify(enrichedResults) }] };
  }
  ...
  private async mapCodesCrosswalk(args: any) {
    ...
    return { content: [{ type: "text", text: JSON.stringify(enrichedMapping) }] };
  }
...
export interface MedicalDatabaseAdapter {
  ...
  searchMedications(term: string, options?: SearchOptions): Promise<MedicationResult[]>;
  ...
  mapCodes(sourceCode: string, sourceSystem: CodeSystem, targetSystem: CodeSystem): Promise<MappingResult[]>;
