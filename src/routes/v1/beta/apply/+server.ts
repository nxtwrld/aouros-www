...
const betaApplicationSchema = z.object({
  ...
  problem_description: z.string().min(10, 'Please provide more detail about your problem'),
  current_solution: z.string().min(10, 'Please provide more detail about your current solution'),
