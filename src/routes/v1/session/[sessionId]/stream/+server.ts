...
import { getSession, getSessionEmitter, type SSEUpdate } from '$lib/session/manager';
            ...
            start(controller) {
                ...
                const initialMessage = {
                    ...
                    data: { 
                        ...
                        stats: {
                            ...
                            analysisInProgress: sessionData.analysisState?.analysisInProgress || false
                        }
                    },
                    timestamp: Date.now()
                };
                ...
                const heartbeatInterval = setInterval(() => {
                    ...
                    try {
                        ...
                        if (err.code === 'ERR_INVALID_STATE') {
                            console.log('⚠️ SSE controller closed during heartbeat, stopping interval');
                            isClosed = true;
                            clearInterval(heartbeatInterval);
                        } else {
