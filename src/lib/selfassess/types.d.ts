...
export enum EntryMode {
  ...
  export interface AssessmentFormCategory<C extends Category> extends AssessmentForm {
    title: string;
    description?: string;
    category: C;
  ...
  type CategorySubCategories = {
    [Category.MentalHealth]: SubCategory.Depression | SubCategory.Anxiety | SubCategory.Stress | SubCategory.MoodTracking | SubCategory.WellnessCheck |  SubCategory.PainManagement;
    [Category.PhysicalHealth]: SubCategory.PainManagement | SubCategory.SymptomTracking | SubCategory.ChronicConditionManagement | SubCategory.FitnessAssessment;
    [Category.GeneralHealth]: SubCategory.BodyMeasurements | SubCategory.VitalSigns | SubCategory.NutritionalIntake | SubCategory.SleepTracking;
    [Category.LabResults]: SubCategory.BloodTests | SubCategory.UrineAnalysis | SubCategory.ImagingResults | SubCategory.OtherLabResults;
    [Category.PreventiveHealth]: SubCategory.HealthScreenings | SubCategory.VaccinationRecords | SubCategory.FamilyHealthHistory;
    [Category.LifestyleWellness]: SubCategory.ExercisePhysicalActivity | SubCategory.DietNutrition | SubCategory.MentalWellness | SubCategory.SubstanceUseAssessment;
  };
