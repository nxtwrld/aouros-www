...
export async function evaluate(content: Content[], type: Types, tokenUsage: TokenUsage): Promise<Report> {
...
const TEST_DATA = [{
    ...
    "recommendations": "Pacient by se měl vyhýbat kontaktu s nemocnými lidmi a místům s vysokou koncentrací osob, aby se snížilo riziko další infekce. Tyto doporučení byly navrženy specialistou.",
    "tokenUsage": {
        "total": 1111,
