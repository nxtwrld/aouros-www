...
export const FEATURE_FLAGS = {
  ...
  ENABLE_MULTI_PROVIDER_AI:
    (env as any).PUBLIC_ENABLE_MULTI_PROVIDER_AI === "true",
  ENABLE_PROVIDER_FALLBACK:
    (env as any).PUBLIC_ENABLE_PROVIDER_FALLBACK === "true",

  // Enhanced signal processing
  ENABLE_ENHANCED_SIGNALS:
    (env as any).PUBLIC_ENABLE_ENHANCED_SIGNALS === "true",
  ENABLE_SIGNAL_MIGRATION:
    (env as any).PUBLIC_ENABLE_SIGNAL_MIGRATION === "true",
  ENABLE_SIGNAL_RELATIONSHIPS:
    (env as any).PUBLIC_ENABLE_SIGNAL_RELATIONSHIPS === "true",
  ENABLE_DYNAMIC_SIGNAL_REGISTRY:
    (env as any).PUBLIC_ENABLE_DYNAMIC_SIGNAL_REGISTRY === "true",

  // Document type specialization
  ENABLE_ENHANCED_SCHEMAS:
    (env as any).PUBLIC_ENABLE_ENHANCED_SCHEMAS === "true",
  ENABLE_DOCUMENT_TYPE_ROUTING:
    (env as any).PUBLIC_ENABLE_DOCUMENT_TYPE_ROUTING === "true",
  ...
  ENABLE_PROCESSING_METRICS:
    (env as any).PUBLIC_ENABLE_PROCESSING_METRICS === "true",
  ...
  ENABLE_WORKFLOW_TRACING:
    (env as any).PUBLIC_ENABLE_WORKFLOW_TRACING === "true",
} as const;
