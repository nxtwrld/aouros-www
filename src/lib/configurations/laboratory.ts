...
export default {
    ...
    "parameters": {
        ...
        "properties": {
            "title": {
                "type": "string",
                "description": "Title of the observation. Translate result to the [LANGUAGE] langauge if the source is in a different language. Provide specific context from the report to clearly identify the report topic."
            },
            "summary": {
                "type": "string",
                "description": "Summary and findings of the observation in natural language. Translate result to the [LANGUAGE] langauge if the source is in a different language. Enhance comprehension by providing a clear and concise summary. Highlight abnormal findings. Result of the lab test."
            },
            "date" : {
                "type": "string",
