...
export default {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "title": {
                "type": "string",
                "description": "Title of the observation. Translate result to the [LANGUAGE] langauge if the source is in a different language. Provide specific context from the report to clearly identify the issues and topic of the report. Use concise and clear language to describe the report subject."    
            },
            "summary": {
                "type": "string",
            ...
            "bodyParts": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "status": {
                            "type": "string",
                            "description": "Status of the tooth. If the tooth is missing, leave it empty. Translate result to the [LANGUAGE] langauge if the source is in a different language."
                        },
                        "diagnosis": {
                            "type": "string",
                            "description": "Diagnosis of the tooth. If the tooth is missing, leave it empty. Translate result to the [LANGUAGE] langauge if the source is in a different language."
                        },
                        "treatment": {
                            "type": "string",
                            "description": "Treatment of the tooth. If the tooth is missing, leave it empty. Translate result to the [LANGUAGE] langauge if the source is in a different language."
                        },
                        "urgency": {
                            "type": "number",
                            "description": "Urgency of the report regarding the body part on a scale of 1-5. 1 - not severe, 5 - very severe. where 1 is non issue - just a general statement, 2 and up are issues detected, that need to be reflected upon."
                        }
                    },
