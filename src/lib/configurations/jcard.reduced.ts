...
export default {
	...
	"properties" :
	{
		...
		"email" :
		{
			"optional" : true ,
			"type" : "array" ,
			"description" : "To specify the electronic mail address for communication with the object the jCard represents. Set undefined if no email address is available." ,
			"items" : 
			{
				"type" : "object" ,
				"properties" : 
		...
		"tel" :
		{
			"optional" : true ,
			"type" : "array" ,
			"description" : "To specify the telephone number for telephony communication with the object the jCard represents. Set undefined if no phone number is available." ,
			"items" : 
			{
				"type" : "object" ,
				"properties" : 
				{
					...
					{
						"type" : "string" ,
						"description" : "A single phone-number value with internation prefix code. If no prefix is available, assume the number is in the same country as the address." ,
						"format" : "phone"
					} 
				}
			}
