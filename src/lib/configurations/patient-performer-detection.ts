...
export default {
  ...
  description: "Extract patient information, medical performers, and technical imaging metadata from DICOM metadata",
  parameters: {
    type: "object",
  properties: {
    ...
    technical: {
      type: "object",
      description: "Technical parameters for the imaging study and devices used",
      properties: {
        // Study Information
        study: {
          type: "object",
        ...
        imageParameters: {
          ...
          properties: {
            pixelSpacing: {
              type: "array",
              items: { type: "number" },
              description: "Pixel spacing in mm [row spacing, column spacing]",
            },
            windowCenter: {
              type: "array", 
              items: { type: "number" },
