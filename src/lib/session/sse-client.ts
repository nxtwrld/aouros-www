...
export class SSEClient extends EventEmitter {
    ...
    private scheduleReconnect() {
        ...
        console.log(`🔄 Scheduling SSE reconnection attempt ${this.reconnectAttempts}/${this.maxReconnectAttempts} in ${this.reconnectDelay}ms`);
    ...
    async sendAudioChunk(audioData: Float32Array): Promise<boolean> {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('✅ Audio chunk sent successfully via HTTP to SSE session:', result);
                return true;
            } else {
