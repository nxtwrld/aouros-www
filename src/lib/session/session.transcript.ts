    ...
    "parameters": {
        ...
        "properties": {
            "isMedicalConversation": {
                "type": "boolean",
                "description": "If the conversation is a medical conversation, set the value to true. Otherwise set the value to false and stop the extraction process. Ignore all other properties and return an empty object."
            },
            "conversation": {
                "type": "array",
                "description": "Take the transcript of the medical conversation between the doctor and the patient and potentially nurse. Do not add any new lines to the conversation. Continue step by step. Step 1: Use the original text and try to split it into a meaningfull conversation where each actor and message has its separate entry. Step 2: Mark each entry with and appropriate speaker tag that makes logicaly sense.",
                "items": {
                    "type": "object",
                    "properties": {
                        "speaker": {
                            ...
                            "description": "The speaker of the conversation. Choose only from the provided enum list."
                        },
                        "text": {
                            "type": "string",
            ...
            "complaint": {
                "type": "string",
                "description": "The topic of the conversation - main nature of the complaint of the patient, in the simplist terms. Provide answer in [LANGUAGE] language."
            },
            "symptoms": {
                "type": "array",
                "items": {
                    ...
                    "properties": {
                        ...
                        "bodyParts": {
                            ...
                            "items": {
                                "type": "string",
                                "description": "The body part where the symptom is located. Select only a matching item from the provided enum list. Otherwise ignore state 'body'.",
                                "enum": []
                            }
                        }
                    },
