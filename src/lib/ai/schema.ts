...
export function updateLanguage(schema: { [key: string]: any }, language: string = 'English') {
...
export function updateString(schema: { [key: string]: any }, string: string, value: string) {
