...
export const classificationConfig = {
  version: "1.0.0",
  description: "Medical document classification configuration for unified medical terms search",
  ...
  categories: {
    ...
    CONSULTATION: {
      ...
      priority: 6, 
      keywords: ["consultation", "visit", "examination", "clinical", "assessment"]
    },
    EMERGENCY: {
      id: "emergency",
      name: "Emergency Care",
    ...
    MENTAL_HEALTH: {
      ...
      name: "Mental Health",
      priority: 11,
      keywords: ["psychology", "psychiatry", "mental", "behavioral", "cognitive"]
    },
    PEDIATRICS: {
      id: "pediatrics",
      name: "Pediatric Care", 
    ...
    OBSTETRICS: {
      ...
      priority: 13,
      keywords: ["pregnancy", "obstetric", "gynecology", "prenatal", "maternal"]
    }
  },
  ...
  temporalTerms: {
    latest: {
      ...
      weight: 2.0,
      examples: [
        "latest", "newest", "most recent", "last", "current"
      ]
    },
    recent: {
      type: "recent", 
      ...
      examples: [
        "recent", "recently", "this month", "past month", "new"
      ]
    },
    previous: {
      type: "previous",
      ...
      examples: [
        "previous", "prior", "earlier", "past", "old", "historical"
      ]
    }
  },
  ...
  termGeneration: {
    ...
    languageInstruction: "IMPORTANT: All medical terms must be generated in English only. Convert any foreign language medical terms to their English equivalents.",
    sources: {
      existingBodyParts: "Use existing 473 body parts from tags.ts (English names only)",
      existingDiagnoses: "Use existing ICD-10 codes from diagnosis analysis (English descriptions)", 
      existingLaboratory: "Use existing LOINC codes and lab properties (English names)",
      standardizedTerms: "Generate standardized English medical terms and Latin scientific names",
      temporalTerms: "Extract temporal markers in English (latest, recent, historical)"
    }
  },
