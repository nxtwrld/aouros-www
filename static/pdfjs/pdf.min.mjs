...
const e = !(
  ...
  K = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
let Y = q.WARNINGS;
function setVerbosityLevel(t) {
  Number.isInteger(t) && (Y = t);
}
function getVerbosityLevel() {
  return Y;
}
function info(t) {
  Y >= q.INFOS && console.log(`Info: ${t}`);
}
function warn(t) {
  Y >= q.WARNINGS && console.log(`Warning: ${t}`);
}
...
const Q = (function BaseExceptionClosure() {
...
class PasswordException extends Q {
  constructor(t, e) {
    super(t, "PasswordException");
    this.code = e;
  }
}
class UnknownErrorException extends Q {
  constructor(t, e) {
    super(t, "UnknownErrorException");
    this.details = e;
  }
}
class InvalidPDFException extends Q {
  constructor(t) {
    super(t, "InvalidPDFException");
  }
}
class MissingPDFException extends Q {
  constructor(t) {
    super(t, "MissingPDFException");
  }
}
class UnexpectedResponseException extends Q {
  constructor(t, e) {
    super(t, "UnexpectedResponseException");
    this.status = e;
  }
}
class FormatError extends Q {
  constructor(t) {
    super(t, "FormatError");
  }
}
class AbortException extends Q {
  constructor(t) {
...
const J = Array.from(Array(256).keys(), (t) => t.toString(16).padStart(2, "0"));
class Util {
...
function normalizeUnicode(t) {
  ...
  return t.replaceAll(Z, (t, e, i) => (e ? e.normalize("NFKC") : tt.get(i)));
}
const et = "pdfjs_internal_id_";
"function" != typeof Promise.try &&
  (Promise.try = function (t, ...e) {
...
class PageViewport {
  constructor({
    ...
    if (0 === h) {
      p = Math.abs(l - t[1]) * i + n;
      g = Math.abs(o - t[0]) * i + a;
      m = (t[3] - t[1]) * i;
      f = (t[2] - t[0]) * i;
    } else {
      p = Math.abs(o - t[0]) * i + n;
...
class RenderingCancelledException extends Q {
  constructor(t, e = 0) {
...
function getXfaPageViewport(t, { scale: e = 1, rotation: i = 0 }) {
  ...
  return new PageViewport({ viewBox: a, userUnit: 1, scale: e, rotation: i });
}
function getRGB(t) {
  if (t.startsWith("#")) {
...
class HighlightToolbar {
  ...
  #f() {
    ...
    t.setAttribute("role", "toolbar");
    t.addEventListener("contextmenu", noContextMenu, {
      signal: this.#m._signal,
    });
  ...
  async #x(t, e) {
    ...
    try {
      ...
      if ("string" == typeof e) {
        ...
        e instanceof File ? (t = i.file = e) : e instanceof Blob && (t = e);
...
class CommandManager {
  ...
  add({
    ...
    if (a && this.#_[this.#C].type === n) {
      r && (o.undo = this.#_[this.#C].undo);
      this.#_[this.#C] = o;
      return;
    }
    const l = this.#C + 1;
    if (l === this.#S) this.#_.splice(0, 1);
    else {
      this.#C = l;
  ...
  undo() {
    if (-1 === this.#C) return;
    this.#E = !0;
    const { undo: t, post: e } = this.#_[this.#C];
    t();
    e?.();
    this.#E = !1;
    this.#C -= 1;
  ...
  redo() {
    if (this.#C < this.#_.length - 1) {
      this.#C += 1;
      this.#E = !0;
      const { cmd: t, post: e } = this.#_[this.#C];
      t();
      e?.();
      this.#E = !1;
    }
  ...
  cleanType(t) {
    if (-1 !== this.#C) {
      for (let e = this.#C; e >= 0; e--)
        if (this.#_[e].type !== t) {
          this.#_.splice(e + 1, this.#C - e);
          this.#C = e;
          return;
        }
      this.#_.length = 0;
...
class AnnotationEditorUIManager {
  ...
  static get _keyboardManager() {
    const t = AnnotationEditorUIManager.prototype,
      arrowChecker = (t) =>
        t.#pt.contains(document.activeElement) &&
  ...
  constructor(t, e, i, s, n, a, r, o, l, h, d, c, u) {
    const p = (this._signal = this.#M.signal);
    this.#pt = t;
    this.#gt = e;
    this.#R = i;
    this._eventBus = s;
    s._on("editingaction", this.onEditingAction.bind(this), { signal: p });
    s._on("pagechanging", this.onPageChanging.bind(this), { signal: p });
    s._on("scalechanging", this.onScaleChanging.bind(this), { signal: p });
    s._on("rotationchanging", this.onRotationChanging.bind(this), {
      signal: p,
    });
    s._on("setpreference", this.onSetPreference.bind(this), { signal: p });
    s._on(
    ...
    this.#bt();
    this.#At();
    this.#I = n.annotationStorage;
    this.#W = n.filterFactory;
    this.#lt = a;
    this.#K = r || null;
    this.#$ = o;
    this.#V = l;
    ...
    this._editorUndoBar = c || null;
    this._supportsPinchToZoom = !1 !== u;
  }
  destroy() {
    this.#mt?.resolve();
    this.#mt = null;
    ...
    this.#M = null;
    this._signal = null;
    for (const t of this.#k.values()) t.destroy();
    this.#k.clear();
    this.#D.clear();
    this.#G.clear();
    this.#P = null;
  ...
  get hcmFilter() {
    return shadow(
      ...
      "hcmFilter",
      this.#lt
        ? this.#W.addHCMFilter(this.#lt.foreground, this.#lt.background)
        : "none",
    );
  }
  get direction() {
  ...
  get highlightColors() {
    return shadow(
      ...
      this.#K
        ? new Map(
            this.#K.split(",").map((t) => t.split("=").map((t) => t.trim())),
          )
        : null,
    );
  }
  ...
  onSetPreference({ name: t, value: e }) {
    if ("enableNewAltTextWhenAddingImage" === t) this.#j = e;
  }
  ...
  disableUserSelect(t = !1) {
    this.#gt.classList.toggle("noUserSelect", t);
  }
  addShouldRescale(t) {
    this.#G.add(t);
  }
  ...
  #vt(t) {
    ...
    for (const e of this.#k.values()) if (e.hasTextLayer(t)) return e;
    return null;
  }
  ...
  #yt() {
    ...
    const e = this.#wt(t).closest(".textLayer"),
      i = this.getSelectionBoxes(e);
    if (i) {
      this.#Q ||= new HighlightToolbar(this);
      this.#Q.show(e, i, "ltr" === this.direction);
    }
  }
  addToAnnotationStorage(t) {
    t.isEmpty() || !this.#I || this.#I.has(t.id) || this.#I.setValue(t.id, t);
  }
  #xt() {
    const t = document.getSelection();
    if (!t || t.isCollapsed) {
      if (this.#ot) {
        this.#Q?.hide();
        this.#ot = null;
        this.#_t({ hasSelectedText: !1 });
      }
      return;
    }
    const { anchorNode: e } = t;
    if (e === this.#ot) return;
    const i = this.#wt(t).closest(".textLayer");
    if (i) {
      this.#Q?.hide();
      this.#ot = e;
      this.#_t({ hasSelectedText: !0 });
      if (this.#at === g.HIGHLIGHT || this.#at === g.NONE) {
        this.#at === g.HIGHLIGHT && this.showAllEditors("highlight", !0, !0);
        this.#Y = this.isShiftKeyDown;
        if (!this.isShiftKeyDown) {
          const t = this.#at === g.HIGHLIGHT ? this.#vt(i) : null;
          t?.toggleDrawing();
          const e = new AbortController(),
            ...
            pointerup = (i) => {
              if ("pointerup" !== i.type || 0 === i.button) {
                e.abort();
                t?.toggleDrawing(!0);
                "pointerup" === i.type && this.#Et("main_toolbar");
              }
            };
  ...
  #ft() {
    document.addEventListener("selectionchange", this.#xt.bind(this), {
      signal: this._signal,
    });
  }
  #St() {
  ...
  #At() {
    ...
    const t = this.combinedSignal(this.#et);
  ...
  #Mt() {
    ...
    const t = this.combinedSignal(this.#O);
  ...
  #_t(t) {
    if (Object.entries(t).some(([t, e]) => this.#dt[t] !== e)) {
      this._eventBus.dispatch("annotationeditorstateschanged", {
        source: this,
        details: Object.assign(this.#dt, t),
      });
      this.#at === g.HIGHLIGHT &&
        !1 === t.hasSelectedEditor &&
        this.#Rt([[m.HIGHLIGHT_FREE, !0]]);
    }
  }
  #Rt(t) {
  ...
  registerEditorTypes(t) {
    if (!this.#U) {
      this.#U = t;
      for (const t of this.#U) this.#Rt(t.defaultPropertiesToUpdate);
    }
  }
  getId() {
    return this.#J.id;
  ...
  addLayer(t) {
    this.#k.set(t.pageIndex, t);
    this.#Z ? t.enable() : t.disable();
  }
  removeLayer(t) {
    this.#k.delete(t.pageIndex);
  }
  async updateMode(t, e = null, i = !1) {
    if (this.#at !== t) {
      ...
      if (t !== g.NONE) {
        ...
        await this.#Ft();
        this.unselectAll();
        for (const e of this.#k.values()) e.updateMode(t);
        if (e) {
  ...
  updateParams(t, e) {
    if (this.#U) {
      ...
      for (const i of this.#rt) i.updateParams(t, e);
      for (const i of this.#U) i.updateDefaultParams(t, e);
    }
  }
  showAllEditors(t, e, i = !1) {
    for (const i of this.#D.values()) i.editorType === t && i.show(e);
    (this.#ht?.get(m.HIGHLIGHT_SHOW_ALL) ?? !0) !== e &&
      this.#Rt([[m.HIGHLIGHT_SHOW_ALL, e]]);
  }
  enableWaiting(t = !1) {
    if (this.#tt !== t) {
      this.#tt = t;
  ...
  async #Ft() {
    if (!this.#Z) {
      this.#Z = !0;
      const t = [];
      for (const e of this.#k.values()) t.push(e.enable());
      await Promise.all(t);
      for (const t of this.#D.values()) t.enable();
    }
  }
  #Lt() {
    this.unselectAll();
    if (this.#Z) {
      this.#Z = !1;
      for (const t of this.#k.values()) t.disable();
      for (const t of this.#D.values()) t.disable();
    }
  }
  getEditors(t) {
    const e = [];
    for (const i of this.#D.values()) i.pageIndex === t && e.push(i);
    return e;
  }
  getEditor(t) {
    return this.#D.get(t);
  ...
  removeEditor(t) {
    ...
    this.#D.delete(t.id);
    this.unselect(t);
    (t.annotationElementId && this.#H.has(t.annotationElementId)) ||
      this.#I?.remove(t.id);
  }
  addDeletedAnnotationElement(t) {
    this.#H.add(t.annotationElementId);
  ...
  removeDeletedAnnotationElement(t) {
    this.#H.delete(t.annotationElementId);
    this.removeChangedExistingAnnotation(t);
    t.deleted = !1;
  }
  #Dt(t) {
    const e = this.#k.get(t.pageIndex);
  ...
  setActiveEditor(t) {
    if (this.#P !== t) {
      this.#P = t;
      t && this.#Rt(t.propertiesToUpdate);
    }
  }
  get #Ot() {
    let t = null;
  ...
  updateUI(t) {
    this.#Ot === t && this.#Rt(t.propertiesToUpdate);
  }
  updateUIForDefaultProperties(t) {
    this.#Rt(t.defaultPropertiesToUpdate);
  }
  toggleSelected(t) {
    if (this.#rt.has(t)) {
      this.#rt.delete(t);
  ...
  setSelected(t) {
    ...
    for (const e of this.#rt) e !== t && e.unselect();
    this.#rt.clear();
    this.#rt.add(t);
    t.select();
    this.#Rt(t.propertiesToUpdate);
  ...
  #It() {
    if (0 === this.#D.size) return !0;
    if (1 === this.#D.size)
      for (const t of this.#D.values()) return t.isEmpty();
    return !1;
  }
  delete() {
    this.commitOrRemove();
    ...
    const e = t ? [t] : [...this.#rt],
      undo = () => {
        for (const t of e) this.#Dt(t);
      };
    this.addCommands({
      cmd: () => {
        this._editorUndoBar?.show(
          undo,
          1 === e.length ? e[0].editorType : e.length,
        );
  ...
  #kt(t) {
    for (const t of this.#rt) t.unselect();
    this.#rt.clear();
    for (const e of t)
      if (!e.isEmpty()) {
        this.#rt.add(e);
  ...
  selectAll() {
    for (const t of this.#rt) t.commit();
  ...
  translateSelectedEditors(t, e, i = !1) {
    ...
    this.#ut = setTimeout(() => {
      ...
      this.addCommands({
        cmd: () => {
          for (const t of a) this.#D.has(t.id) && t.translateInPage(s, n);
        },
        undo: () => {
          for (const t of a) this.#D.has(t.id) && t.translateInPage(-s, -n);
        },
  ...
  endDragSession() {
    ...
    this.addCommands({
      cmd: () => {
        for (const [e, { newX: i, newY: s, newPageIndex: n }] of t)
          move(e, i, s, n);
      },
      undo: () => {
        for (const [e, { savedX: i, savedY: s, savedPageIndex: n }] of t)
          move(e, i, s, n);
      },
      mustExec: !0,
    });
  ...
  addChangedExistingAnnotation({ annotationElementId: t, id: e }) {
    (this.#F ||= new Map()).set(t, e);
  }
  removeChangedExistingAnnotation({ annotationElementId: t }) {
    this.#F?.delete(t);
  }
  renderAnnotationElement(t) {
    const e = this.#F?.get(t.data.id);
    if (!e) return;
    const i = this.#I.getRawValue(e);
    i &&
      (this.#at !== g.NONE || i.hasBeenModified) &&
...
class AltText {
  ...
  constructor(t) {
    this.#a = t;
    this.#Wt = t._uiManager.useNewAltTextFlow;
    AltText.#qt ||= Object.freeze({
  ...
  async render() {
    const t = (this.#Bt = document.createElement("button"));
    t.className = "altText";
    t.tabIndex = "0";
    const e = (this.#Ht = document.createElement("span"));
    t.append(e);
    if (this.#Wt) {
      t.classList.add("new");
      t.setAttribute("data-l10n-id", AltText.#qt.missing);
      e.setAttribute("data-l10n-id", AltText.#qt["missing-label"]);
    } else {
  ...
  async setGuessedText(t) {
    if (null === this.#o) {
      this.#Vt = t;
      this.#jt = await AltText._l10n.get(
  ...
  toggleAltTextBadge(t = !1) {
    if (this.#Wt && !this.#o) {
      ...
      this.#$t.classList.toggle("hidden", !t);
    } else {
      this.#$t?.remove();
      this.#$t = null;
    }
  ...
  serialize(t) {
    let e = this.#o;
    t || this.#Vt !== e || (e = this.#jt);
    return {
      altText: e,
      decorative: this.#Nt,
      guessedText: this.#Vt,
      textWithDisclaimer: this.#jt,
    };
  }
  get data() {
  ...
  async #Kt() {
    ...
    if (this.#Wt) {
      ...
      t.setAttribute("data-l10n-id", AltText.#qt[this.#Xt]);
      this.#Ht?.setAttribute("data-l10n-id", AltText.#qt[`${this.#Xt}-label`]);
      if (!this.#o) {
        this.#zt?.remove();
        return;
      }
...
class TouchManager {
  ...
  constructor({
    ...
    this.#ie = AbortSignal.any([r, this.#ne.signal]);
    t.addEventListener("touchstart", this.#re.bind(this), {
      passive: !1,
      signal: this.#ie,
    });
  }
  ...
  #re(t) {
    if (this.#Jt?.() || t.touches.length < 2) return;
    if (!this.#ae) {
      this.#ae = new AbortController();
      const t = AbortSignal.any([this.#ie, this.#ae.signal]),
        e = this.#pt,
        i = { signal: t, passive: !1 };
      e.addEventListener("touchmove", this.#oe.bind(this), i);
      e.addEventListener("touchend", this.#le.bind(this), i);
      e.addEventListener("touchcancel", this.#le.bind(this), i);
      this.#Zt?.();
    }
    stopEvent(t);
    if (2 !== t.touches.length || this.#Qt?.()) {
      this.#se = null;
      return;
    }
    let [e, i] = t.touches;
  ...
  #oe(t) {
    if (!this.#se || 2 !== t.touches.length) return;
    let [e, i] = t.touches;
    e.identifier > i.identifier && ([e, i] = [i, e]);
    const { screenX: s, screenY: n } = e,
    ...
    if (
      !this.#Yt &&
      Math.abs(b - f) <= TouchManager.MIN_TOUCH_DISTANCE_TO_PINCH
    )
      return;
    o.touch0X = s;
    o.touch0Y = n;
...
class AnnotationEditor {
  ...
  focusin(t) {
    this._focusEventsAllowed &&
      (this.#ve ? (this.#ve = !1) : this.parent.setSelected(this));
  }
  focusout(t) {
  ...
  translate(t, e) {
    this.#Ie(this.parentDimensions, t, e);
  }
  translateInPage(t, e) {
    this.#ye ||= [this.x, this.y, this.width, this.height];
    this.#Ie(this.pageDimensions, t, e);
  ...
  get _hasBeenResized() {
    return (
      !!this.#ye && (this.#ye[2] !== this.width || this.#ye[3] !== this.height)
    );
  }
  getBaseTranslation() {
  ...
  fixAndSetPosition(t = this.rotation) {
    ...
    let { x: n, y: a, width: r, height: o } = this;
    r *= i;
    o *= s;
    n *= i;
    a *= s;
    if (this._mustFixPosition)
      switch (t) {
        case 0:
          ...
          a = Math.max(0, Math.min(s - o, a));
          break;
        case 90:
          n = Math.max(0, Math.min(i - o, n));
          a = Math.min(s, Math.max(r, a));
          break;
        case 180:
          n = Math.min(i, Math.max(r, n));
          a = Math.min(s, Math.max(o, a));
          break;
        case 270:
          n = Math.min(i, Math.max(o, n));
          a = Math.max(0, Math.min(s - r, a));
      }
    this.x = n /= i;
    this.y = a /= s;
  ...
  screenToPageTranslation(t, e) {
    return AnnotationEditor.#Fe(t, e, this.parentRotation);
  }
  pageTranslationToScreen(t, e) {
    return AnnotationEditor.#Fe(t, e, 360 - this.parentRotation);
  }
  #Le(t) {
    switch (t) {
      case 90: {
  ...
  setDims(t, e) {
    const [i, s] = this.parentDimensions,
      { style: n } = this.div;
    n.width = `${((100 * t) / i).toFixed(2)}%`;
    this.#ge || (n.height = `${((100 * e) / s).toFixed(2)}%`);
  }
  fixDims() {
    const { style: t } = this.div,
      { height: e, width: i } = t,
      s = i.endsWith("%"),
      n = !this.#ge && e.endsWith("%");
    if (s && n) return;
    const [a, r] = this.parentDimensions;
    s || (t.width = `${((100 * parseFloat(i)) / a).toFixed(2)}%`);
    this.#ge || n || (t.height = `${((100 * parseFloat(e)) / r).toFixed(2)}%`);
  }
  ...
  #Oe() {
    ...
    for (const i of t) {
      ...
      t.addEventListener("pointerdown", this.#Ne.bind(this, i), { signal: e });
      t.addEventListener("contextmenu", noContextMenu, { signal: e });
      t.tabIndex = -1;
    }
  ...
  #Ne(t, e) {
    ...
    this._isDraggable = !1;
    this.#fe = [e.screenX, e.screenY];
    const n = new AbortController(),
      a = this._uiManager.combinedSignal(n);
    this.parent.togglePointerEvents(!1);
    window.addEventListener("pointermove", this.#Be.bind(this, t), {
      passive: !0,
      capture: !0,
      signal: a,
    });
    window.addEventListener("touchmove", stopEvent, { passive: !1, signal: a });
    ...
    const r = this.parent.div.style.cursor,
  ...
  #He() {
    if (!this.#be) return;
    const { savedX: t, savedY: e, savedWidth: i, savedHeight: s } = this.#be;
    this.#be = null;
    const n = this.x,
      a = this.y,
      r = this.width,
    ...
    (n === t && a === e && r === i && o === s) ||
      this.addCommands({
        cmd: this.#ze.bind(this, n, a, r, o),
        undo: this.#ze.bind(this, t, e, i, s),
        mustExec: !0,
      });
  }
  static _round(t) {
  ...
  #Be(t, e) {
    const [i, s] = this.parentDimensions,
      ...
      d = this.#Le(this.rotation),
      transf = (t, e) => [d[0] * t + d[2] * e, d[1] * t + d[3] * e],
      c = this.#Le(360 - this.rotation);
    let u,
      p,
      g = !1,
      m = !1;
    ...
    const f = u(r, o),
      b = p(r, o);
    let A = transf(...b);
    const w = AnnotationEditor._round(n + A[0]),
      v = AnnotationEditor._round(a + A[1]);
    let y,
      x,
      _ = 1,
      E = 1;
    if (e.fromKeyboard) ({ deltaX: y, deltaY: x } = e);
    else {
      const { screenX: t, screenY: i } = e,
        [s, n] = this.#fe;
      [y, x] = this.screenToPageTranslation(t - s, i - n);
      this.#fe[0] = t;
      this.#fe[1] = i;
    }
    [y, x] =
      ((S = y / i), (C = x / s), [c[0] * S + c[2] * C, c[1] * S + c[3] * C]);
    var S, C;
    if (g) {
      const t = Math.hypot(r, o);
      _ = E = Math.max(
        Math.min(
          Math.hypot(b[0] - f[0] - y, b[1] - f[1] - x) / t,
          1 / r,
          1 / o,
        ),
        l / r,
      ...
      m
        ? (_ = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - y))) / r)
        : (E = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - x))) / o);
    const T = AnnotationEditor._round(r * _),
      M = AnnotationEditor._round(o * E);
    A = transf(...p(T, M));
    const P = w - A[0],
      D = v - A[1];
    this.#ye ||= [this.x, this.y, this.width, this.height];
  ...
  render() {
    ...
    this.isResizable &&
      ...
      (this.#Pe ||= new TouchManager({
        container: this.div,
        isPinchingDisabled: () => !this.isSelected,
        onPinchStart: this.#Ge.bind(this),
        onPinching: this.#$e.bind(this),
        onPinchEnd: this.#Ve.bind(this),
  ...
  #$e(t, e, i) {
    let s = (i / e) * 0.7 + 1 - 0.7;
    if (1 === s) return;
    const n = this.#Le(this.rotation),
      transf = (t, e) => [n[0] * t + n[2] * e, n[1] * t + n[3] * e],
      [a, r] = this.parentDimensions,
      o = this.x,
      l = this.y,
      h = this.width,
      d = this.height,
      c = AnnotationEditor.MIN_SIZE / a,
      u = AnnotationEditor.MIN_SIZE / r;
    s = Math.max(Math.min(s, 1 / h, 1 / d), c / h, u / d);
    const p = AnnotationEditor._round(h * s),
      g = AnnotationEditor._round(d * s);
    if (p === h && g === d) return;
    this.#ye ||= [o, l, h, d];
    const m = transf(h / 2, d / 2),
      f = AnnotationEditor._round(o + m[0]),
      b = AnnotationEditor._round(l + m[1]),
      A = transf(p / 2, g / 2);
    this.x = f - A[0];
    this.y = b - A[1];
    this.width = p;
    this.height = g;
    this.setDims(a * p, r * g);
    this.fixAndSetPosition();
    this._onResizing();
  }
  #Ve() {
  ...
  pointerdown(t) {
    ...
    if (0 !== t.button || (t.ctrlKey && e)) t.preventDefault();
      ...
      this.#ve = !0;
      this._isDraggable ? this.#je(t) : this.#We(t);
    }
  }
  get isSelected() {
  ...
  #je(t) {
    ...
    const s = new AbortController(),
      ...
      cancelDrag = (t) => {
        ...
        this.#ue = null;
        this.#ve = !1;
        this._uiManager.endDragSession() || this.#We(t);
    ...
    if (e) {
      ...
      window.addEventListener(
        ...
        (t) => {
          ...
          const [a, r] = this.screenToPageTranslation(
            e - this.#Ce,
            s - this.#Te,
          );
          this.#Ce = e;
      ...
      window.addEventListener("touchmove", stopEvent, a);
      window.addEventListener(
        "pointerdown",
        (t) => {
          t.pointerType === this.#pe &&
            (this.#Pe || t.isPrimary) &&
            cancelDrag(t);
          stopEvent(t);
        },
    ...
    const pointerUpCallback = (t) => {
      this.#ue && this.#ue !== t.pointerId ? stopEvent(t) : cancelDrag(t);
    };
    window.addEventListener("pointerup", pointerUpCallback, { signal: n });
    window.addEventListener("blur", pointerUpCallback, { signal: n });
  }
  _onStartDragging() {}
  _onStopDragging() {}
  moveInDOM() {
  ...
  get isOnScreen() {
    const { top: t, left: e, bottom: i, right: s } = this.getClientDimensions(),
  ...
  #Ue() {
    ...
    this.#Ae = new AbortController();
    const t = this._uiManager.combinedSignal(this.#Ae);
  ...
  remove() {
    ...
    if (this.#Me) {
      for (const t of this.#Me.values()) clearTimeout(t);
      this.#Me = null;
    }
    this.parent = null;
    this.#Pe?.destroy();
  ...
  keydown(t) {
    ...
    const e = this.#me.children;
    if (!this.#de) {
      this.#de = Array.from(e);
      const t = this.#qe.bind(this),
        i = this.#Xe.bind(this),
      ...
      for (const e of this.#de) {
        ...
        e.addEventListener("focus", this.#Ke.bind(this, n), { signal: s });
    ...
    if (n !== s) {
      if (n < s)
        for (let t = 0; t < s - n; t++) this.#me.append(this.#me.firstChild);
      else if (n > s)
        for (let t = 0; t < n - s; t++)
          this.#me.firstChild.before(this.#me.lastChild);
      let t = 0;
      for (const i of e) {
        const e = this.#de[t++].getAttribute("data-resizer-name");
        i.setAttribute("data-l10n-id", AnnotationEditor._l10nResizer[e]);
      }
    }
    this.#Ye(0);
    this.#Ee = !0;
    this.#me.firstChild.focus({ focusVisible: !0 });
    t.preventDefault();
  ...
  #Xe(t) {
    this.#Ee && t.relatedTarget?.parentNode !== this.#me && this.#Re();
  }
  #Ke(t) {
    this.#we = this.#Ee ? t : "";
  }
  #Ye(t) {
    if (this.#de) for (const e of this.#de) e.tabIndex = t;
  }
  _resizeWithKeyboard(t, e) {
    this.#Ee && this.#Be(this.#we, { deltaX: t, deltaY: e, fromKeyboard: !0 });
  }
  #Re() {
    this.#Ee = !1;
    this.#Ye(-1);
...
class MurmurHash3_64 {
  constructor(t) {
    this.h1 = t ? 4294967295 & t : st;
    this.h2 = t ? 4294967295 & t : st;
  }
  update(t) {
    let e, i;
    if ("string" == typeof t) {
  ...
  hexdigest() {
    let t = this.h1,
      e = this.h2;
    t ^= e >>> 1;
    t = ((3981806797 * t) & nt) | ((36045 * t) & at);
    e =
      ((4283543511 * e) & nt) |
      (((2950163797 * ((e << 16) | (t >>> 16))) & nt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & nt) | ((60499 * t) & at);
    e =
      ((3301882366 * e) & nt) |
      (((3120437893 * ((e << 16) | (t >>> 16))) & nt) >>> 16);
    t ^= e >>> 1;
    return (
...
const rt = Object.freeze({ map: null, hash: "", transfer: void 0 });
class AnnotationStorage {
  ...
  remove(t) {
    ...
    if ("function" == typeof this.onAnnotationEditor) {
      for (const t of this.#Ze.values())
        if (t instanceof AnnotationEditor) return;
      this.onAnnotationEditor(null);
    }
  }
  setValue(t, e) {
  ...
  get serializable() {
    ...
    return t.size > 0 ? { map: t, hash: e.hexdigest(), transfer: i } : rt;
  }
  get editorStats() {
    let t = null;
    const e = new Map();
    for (const i of this.#Ze.values()) {
  ...
  get modifiedIds() {
    ...
    const t = [];
    for (const e of this.#Ze.values())
      e instanceof AnnotationEditor &&
        e.annotationElementId &&
        e.serialize() &&
        t.push(e.annotationElementId);
    return (this.#Je = { ids: new Set(t), hash: t.join(",") });
  }
}
class PrintAnnotationStorage extends AnnotationStorage {
  ...
  constructor(t) {
    ...
    this.#ei = { map: n, hash: i, transfer: s };
  }
  get print() {
...
class FontFaceObject {
  ...
  createFontFaceRule() {
    if (!this.data || this.disableFontFace) return null;
    const t = `url(data:${this.mimetype};base64,${(function toBase64Util(t) {
      return Uint8Array.prototype.toBase64
        ? t.toBase64()
        : btoa(bytesToString(t));
    })(this.data)});`;
    let e;
    if (this.cssFontInfo) {
  ...
  getPathGenerator(t, e) {
    ...
    this.fontExtraProperties || t.delete(i);
...
function wrapReason(t) {
  if (
    ...
    t instanceof InvalidPDFException ||
    t instanceof MissingPDFException ||
    t instanceof PasswordException ||
    t instanceof UnexpectedResponseException ||
    t instanceof UnknownErrorException
  )
    return t;
  t instanceof Error ||
  ...
  switch (t.name) {
    ...
    case "InvalidPDFException":
      return new InvalidPDFException(t.message);
...
class MessageHandler {
  ...
  constructor(t, e, i) {
    ...
    i.addEventListener("message", this.#ni.bind(this), {
      signal: this.#si.signal,
    });
  }
  #ni({ data: t }) {
    ...
    if (t.callback) {
      ...
      if (t.callback === ot) i.resolve(t.data);
      else {
        if (t.callback !== lt) throw new Error("Unexpected callback case");
    ...
    } else t.streamId ? this.#ri(t) : e(t.data);
  }
  on(t, e) {
    ...
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage(
            { sourceName: i, targetName: s, stream: ut, streamId: e, chunk: t },
            r,
          );
        },
        close() {
  ...
  #ai(t) {
    ...
    switch (t.stream) {
      case ft:
        t.success
          ? a.startCall.resolve()
          : a.startCall.reject(wrapReason(t.reason));
        break;
      case mt:
        t.success
          ? a.pullCall.resolve()
          : a.pullCall.reject(wrapReason(t.reason));
        break;
      case gt:
        if (!r) {
          n.postMessage({
        ...
        Promise.try(r.onPull || onFn).then(
          function () {
            n.postMessage({
              sourceName: i,
              targetName: s,
      ...
      case dt:
        t.success
          ...
          : a.cancelCall.reject(wrapReason(t.reason));
        this.#oi(a, e);
        break;
      case ht:
        if (!r) break;
        const o = wrapReason(t.reason);
        Promise.try(r.onCancel || onFn, o).then(
          function () {
            n.postMessage({
              sourceName: i,
              targetName: s,
...
class BaseCanvasFactory {
  ...
  create(t, e) {
    ...
    return {
      canvas: i,
      context: i.getContext("2d", { willReadFrequently: !this.#li }),
    };
  }
  reset(t, e, i) {
...
class DOMCMapReaderFactory extends BaseCMapReaderFactory {
  async _fetch(t) {
    const e = await fetchData(t, this.isCompressed ? "arraybuffer" : "text");
    return e instanceof ArrayBuffer ? new Uint8Array(e) : stringToBytes(e);
  }
}
...
class DOMStandardFontDataFactory extends BaseStandardFontDataFactory {
  async _fetch(t) {
    const e = await fetchData(t, "arraybuffer");
    return new Uint8Array(e);
  }
}
e && warn("Please use the `legacy` build in Node.js environments.");
async function node_utils_fetchData(t) {
...
function drawTriangle(t, e, i, s, n, a, r, o) {
  ...
  for (let t = M; t <= P; t++) {
    ...
    O = v - (v - C) * e;
    N = y - (y - T) * e;
    const i = Math.round(Math.min(D, F)),
      s = Math.round(Math.max(D, F));
    let n = c * t + 4 * i;
    for (let t = i; t <= s; t++) {
      e = (D - t) / (D - F);
      e < 0 ? (e = 0) : e > 1 && (e = 1);
...
class MeshShadingPattern extends BaseShadingPattern {
  ...
  getPattern(t, e, i, s) {
    ...
    let n;
    if (s === wt)
      n = Util.singularValueDecompose2dScale(getCurrentTransform(t));
    else {
...
class TilingPattern {
  ...
  createPatternCanvas(t) {
    ...
    const _ = Math.ceil(o * b),
      E = Math.ceil(l * A);
    _ >= Math.ceil(p * b) ? (w = o) : (y = !0);
    E >= Math.ceil(g * A) ? (v = l) : (x = !0);
    const S = this.getSizeAndScale(w, this.ctx.canvas.width, b),
      C = this.getSizeAndScale(v, this.ctx.canvas.height, A),
      T = t.cachedCanvases.getCanvas("pattern", S.size, C.size),
      M = T.context,
      P = r.createCanvasGraphics(M);
    P.groupLevel = t.groupLevel;
    this.setFillAndStrokeStyleToContext(P, s, a);
    M.translate(-S.scale * h, -C.scale * d);
    P.transform(S.scale, 0, 0, C.scale, 0, 0);
    M.save();
    this.clipBbox(P, h, d, c, u);
    P.baseTransform = getCurrentTransform(P.ctx);
    P.executeOperatorList(i);
    P.endDrawing();
    M.restore();
    if (y || x) {
      const e = T.canvas;
      y && (w = o);
      x && (v = l);
      const i = this.getSizeAndScale(w, this.ctx.canvas.width, b),
        s = this.getSizeAndScale(v, this.ctx.canvas.height, A),
        n = i.size,
        a = s.size,
        r = t.cachedCanvases.getCanvas("pattern-workaround", n, a),
        c = r.context,
        u = y ? Math.floor(p / o) : 0,
        m = x ? Math.floor(g / l) : 0;
      for (let t = 0; t <= u; t++)
        for (let i = 0; i <= m; i++)
          c.drawImage(e, n * t, a * i, n, a, 0, 0, n, a);
      return {
        canvas: r.canvas,
        scaleX: i.scale,
        scaleY: s.scale,
...
function drawImageAtIntegerCoords(t, e, i, s, n, a, r, o, l, h) {
  ...
  if (0 === c && 0 === u) {
    const f = r * d + g,
      ...
      x = (o + h) * p + m,
      _ = Math.abs(Math.round(x) - w) || 1;
    t.setTransform(Math.sign(d), 0, 0, Math.sign(p), b, w);
    t.drawImage(e, i, s, n, a, 0, 0, y, _);
...
class CanvasExtraState {
  ...
  getPathBoundingBox(t = bt, e = null) {
  ...
  getClippedPathBoundingBox(t = bt, e = null) {
...
const _t = ["butt", "round", "square"],
  Et = ["miter", "round", "bevel"],
  St = {},
  Ct = {};
class CanvasGraphics {
  ...
  executeOperatorList(t, e, i, s) {
    ...
    for (;;) {
      ...
      p = a[r];
      if (p !== X.dependency) this[p].apply(this, n[r]);
      else
        for (const t of n[r]) {
  ...
  _createMaskCanvas(t) {
    ...
    w.transform(...c);
    if (!h) {
      h = this._scaleImage(d.canvas, getCurrentTransformInverse(w));
      h = h.img;
      o && a && o.set(l, h);
    }
    w.imageSmoothingEnabled = getImageSmoothingEnabled(
      getCurrentTransform(w),
      t.interpolate,
    );
    drawImageAtIntegerCoords(w, h, 0, 0, h.width, h.height, 0, 0, i, s);
    w.globalCompositeOperation = "source-in";
    const x = Util.transform(getCurrentTransformInverse(w), [
      1,
      0,
      0,
      1,
    ...
    w.fillStyle = a ? n.getPattern(e, this, x, bt) : n;
    w.fillRect(0, 0, i, s);
    if (o && !a) {
      this.cachedCanvases.delete("fillCanvas");
      o.set(l, A.canvas);
    }
    return { canvas: A.canvas, offsetX: Math.round(v), offsetY: Math.round(y) };
  }
  setLineWidth(t) {
  ...
  fill(t = !0) {
    ...
    if (this.current.patternFill) {
      e.save();
      e.fillStyle = i.getPattern(e, this, getCurrentTransformInverse(e), bt);
      s = !0;
    }
  ...
  endText() {
    ...
    const i = new Path2D(),
      s = e.getTransform().invertSelf();
    for (const { transform: e, x: n, y: a, fontSize: r, path: o } of t)
      i.addPath(
        o,
        new DOMMatrix(e).preMultiplySelf(s).translate(n, a).scale(r, -r),
      );
    e.clip(i);
    e.beginPath();
  ...
  setFont(t, e) {
    ...
    (0 !== n.fontMatrix[0] && 0 !== n.fontMatrix[3]) ||
      warn("Invalid font matrix for font " + t);
    if (e < 0) {
      e = -e;
      n.fontDirection = -1;
  ...
  #ci(t, e, i) {
    const s = new Path2D();
    s.addPath(t, new DOMMatrix(i).invertSelf().multiplySelf(e));
    return s;
  }
  paintChar(t, e, i, s, n) {
    const a = this.ctx,
      r = this.current,
      o = r.font,
      l = r.textRenderingMode,
      h = r.fontSize / r.fontSizeScale,
      d = l & y,
      c = !!(l & x),
      u = r.patternFill && !o.missingFile,
      p = r.patternStroke && !o.missingFile;
    let g;
    (o.disableFontFace || c || u || p) &&
      (g = o.getPathGenerator(this.commonObjs, t));
    if (o.disableFontFace || u || p) {
      a.save();
      a.translate(e, i);
      a.scale(h, -h);
      if (d === b || d === w)
        if (s) {
          ...
          a.setTransform(...s);
          a.fill(this.#ci(g, t, s));
        } else a.fill(g);
      if (d === A || d === w)
        if (n) {
          const t = a.getTransform();
          a.setTransform(...n);
          a.stroke(this.#ci(g, t, n));
        } else {
          a.lineWidth /= h;
          a.stroke(g);
        }
      ...
      (d !== b && d !== w) || a.fillText(t, e, i);
      (d !== A && d !== w) || a.strokeText(t, e, i);
    }
    if (c) {
      (this.pendingTextPaths ||= []).push({
        transform: getCurrentTransform(a),
        x: e,
        y: i,
        fontSize: h,
        path: g,
  ...
  showText(t) {
    ...
    if (e.patternStroke) {
      n.save();
      const t = e.strokeColor.getPattern(
        n,
        this,
        getCurrentTransformInverse(n),
        At,
      );
      v = getCurrentTransform(n);
      n.restore();
      n.strokeStyle = t;
    }
    let x = e.lineWidth;
    ...
    if (0 === _ || 0 === x) {
      const t = e.textRenderingMode & y;
      (t !== A && t !== w) || (x = this.getSinglePixelWidth());
    } else x /= _;
    if (1 !== a) {
      n.scale(a, a);
      x /= a;
    ...
    for (E = 0; E < d; ++E) {
      ...
      if (this.contentVisible && (e.isInFont || i.missingFile))
        if (m && !A) n.fillText(b, w, y);
        else {
          this.paintChar(b, w, y, f, v);
          if (A) {
            const t = w + (s * A.offset.x) / a,
              e = y - (s * A.offset.y) / a;
            this.paintChar(A.fontChar, t, e, f, v);
          }
        }
      S += c ? x * g - d * l : x * g + d * l;
      h && n.restore();
  ...
  shadingFill(t) {
    ...
    e.fillStyle = i.getPattern(e, this, getCurrentTransformInverse(e), wt);
  ...
  endGroup(t) {
    ...
    if (t.smask) {
      ...
      const i = Util.getAxialAlignedBoundingBox(
  ...
  beginAnnotation(t, e, i, s, n) {
    ...
    if (e) {
      ...
      if (n && this.annotationCanvasMap) {
        ...
        e[2] = s;
        e[3] = a;
        const [n, r] = Util.singularValueDecompose2dScale(
  ...
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      ...
      h.fillStyle = s
        ? i.getPattern(h, this, getCurrentTransformInverse(e), bt)
        : i;
      h.fillRect(0, 0, a, r);
      h.restore();
      e.save();
  ...
  paintInlineImageXObject(t) {
    ...
    n.imageSmoothingEnabled = getImageSmoothingEnabled(
      getCurrentTransform(n),
      t.interpolate,
    );
  ...
  consumePath(t) {
    ...
    const i = this.ctx;
    if (this.pendingClip) {
      e || (this.pendingClip === Ct ? i.clip("evenodd") : i.clip());
      this.pendingClip = null;
    }
...
for (const t in X)
  void 0 !== CanvasGraphics.prototype[t] &&
    (CanvasGraphics.prototype[X[t]] = CanvasGraphics.prototype[t]);
...
class Metadata {
  ...
  get(t) {
    return this.#gi.get(t) ?? null;
  }
  getAll() {
    return objectFromMap(this.#gi);
  }
  has(t) {
    return this.#gi.has(t);
  }
}
const Tt = Symbol("INTERNAL");
class OptionalContentGroup {
  ...
  get visible() {
    ...
    return this.#fi
      ? "OFF" !== e?.viewState
      : !this.#bi || "OFF" !== t?.printState;
  }
  _setVisible(t, e, i = !1) {
    t !== Tt && unreachable("Internal method `_setVisible` called.");
    this.#Ai = i;
    this.#wi = e;
  }
}
class OptionalContentConfig {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      for (const i of t.groups)
        this.#yi.set(i.id, new OptionalContentGroup(e, i));
      if ("OFF" === t.baseState)
        for (const t of this.#yi.values()) t._setVisible(Tt, !1);
      for (const e of t.on) this.#yi.get(e)._setVisible(Tt, !0);
      for (const e of t.off) this.#yi.get(e)._setVisible(Tt, !1);
  ...
  isVisible(t) {
    ...
    if ("OCG" === t.type) {
      ...
      return this.#yi.get(t.id).visible;
    }
    if ("OCMD" === t.type) {
      ...
      if (!t.policy || "AnyOn" === t.policy) {
        for (const e of t.ids) {
          ...
          if (this.#yi.get(e).visible) return !0;
        }
        return !1;
      }
      if ("AllOn" === t.policy) {
        for (const e of t.ids) {
          ...
          if (!this.#yi.get(e).visible) return !1;
        }
        return !0;
      }
      if ("AnyOff" === t.policy) {
  ...
  setVisibility(t, e = !0, i = !0) {
    const s = this.#yi.get(t);
    if (s) {
      if (i && e && s.rbGroups.length)
        for (const e of s.rbGroups)
          for (const i of e)
            i !== t && this.#yi.get(i)?._setVisible(Tt, !1, !0);
      s._setVisible(Tt, !!e, !0);
      this.#vi = null;
  ...
  getGroup(t) {
    return this.#yi.get(t) || null;
  }
  getHash() {
    if (null !== this.#vi) return this.#vi;
    const t = new MurmurHash3_64();
    for (const [e, i] of this.#yi) t.update(`${e}:${i.visible}`);
    return (this.#vi = t.hexdigest());
  }
}
  ...
  if (e) {
    let t = (function getFilenameFromContentDispositionHeader(t) {
      ...
      function rfc5987decode(t) {
        ...
        return -1 === e
          ? t
          : textdecode(t.slice(0, e), t.slice(e + 1).replace(/^[^']*'/, ""));
      }
...
class PDFFetchStreamReader {
  constructor(t) {
    ...
    fetch(
      s,
      createFetchOptions(i, this._withCredentials, this._abortController),
    )
      .then((e) => {
        t._responseOrigin = getResponseOrigin(e.url);
        if (!validateResponseStatus(e.status))
          throw createResponseStatusError(e.status, s);
        this._reader = e.body.getReader();
        this._headersCapability.resolve();
        const i = e.headers,
          { allowRangeRequests: n, suggestedLength: a } =
...
class PDFFetchStreamRangeReader {
  constructor(t, e, i) {
    ...
    fetch(
      a,
      createFetchOptions(n, this._withCredentials, this._abortController),
    )
      .then((e) => {
        const i = getResponseOrigin(e.url);
        if (i !== t._responseOrigin)
          throw new Error(
            `Expected range response-origin "${i}" to match "${t._responseOrigin}".`,
          );
        if (!validateResponseStatus(e.status))
          throw createResponseStatusError(e.status, a);
...
class NetworkManager {
  ...
  request(t) {
    ...
    assert(t.onError, "Expected `onError` callback to be provided.");
    e.onerror = () => {
      t.onError(e.status);
    };
  ...
  onStateChange(t, e) {
    ...
    if (206 === n) {
      ...
      if (e) i.onDone({ begin: parseInt(e[1], 10), chunk: a });
      else {
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    ...
    this._manager._responseOrigin = getResponseOrigin(e.responseURL);
    ...
    this._contentLength = a || this._contentLength;
    this._filename = extractFilenameFromHeader(s);
...
class PDFNetworkStreamRangeRequestReader {
  ...
  _onHeadersReceived() {
    const t = getResponseOrigin(
      this._manager.getRequestXhr(this._requestId)?.responseURL,
    );
    if (t !== this._manager._responseOrigin) {
      this._storedError = new Error(
        `Expected range response-origin "${t}" to match "${this._manager._responseOrigin}".`,
      );
      this._onError(0);
    }
  }
...
class PDFNodeStream {
  ...
  getRangeReader(t, e) {
    if (e <= this._progressiveDataLength) return null;
    const i = new PDFNodeStreamFsRangeReader(this, t, e);
    this._rangeRequestReaders.push(i);
    return i;
  }
  cancelAllRequests(t) {
...
class PDFNodeStreamFsFullReader {
  constructor(t) {
    ...
    i.promises.lstat(this._url).then(
      (t) => {
      ...
      (t) => {
        "ENOENT" === t.code &&
          (t = new MissingPDFException(`Missing PDF "${this._url}".`));
        this._storedError = t;
        this._headersCapability.reject(t);
      },
    );
...
class PDFNodeStreamFsRangeReader {
  constructor(t, e, i) {
    ...
    this._setReadableStream(
      n.createReadStream(this._url, { start: e, end: i - 1 }),
    );
  }
  get isStreamingSupported() {
    return this._isStreamingSupported;
...
class TextLayer {
  ...
  static #Gi = new Map();
  static #$i = new Map();
  static #Vi = new WeakMap();
  static #ji = null;
  static #Wi = new Set();
  constructor({ textContentSource: t, container: e, viewport: i }) {
    if (t instanceof ReadableStream) this.#Bi = t;
    else {
      if ("object" != typeof t)
        throw new Error('No "textContentSource" parameter specified.');
      this.#Bi = new ReadableStream({
        start(e) {
          e.enqueue(t);
          e.close();
        },
  ...
  render() {
    const pump = () => {
      this.#Ri.read().then(({ value: t, done: e }) => {
        if (e) this.#Si.resolve();
        else {
          this.#Mi ??= t.lang;
          Object.assign(this.#Oi, t.styles);
          this.#Xi(t.items);
          pump();
        }
      }, this.#Si.reject);
  ...
  update({ viewport: t, onBefore: e = null }) {
    ...
    if (s !== this.#Fi) {
      e?.();
      this.#Fi = s;
      setLayerDimensions(this.#Ii, { rotation: s });
    }
    if (i !== this.#Li) {
      e?.();
      this.#Li = i;
      const t = { div: null, properties: null, ctx: TextLayer.#Ki(this.#Mi) };
      for (const e of this.#Hi) {
        t.properties = this.#zi.get(e);
        t.div = e;
        this.#Yi(t);
      }
    }
  ...
  #Xi(t) {
    if (this.#Ci) return;
    this.#Pi.ctx ??= TextLayer.#Ki(this.#Mi);
    const e = this.#Hi,
      i = this.#Ni;
    for (const s of t) {
      if (e.length > 1e5) {
      ...
      if (void 0 !== s.str) {
        ...
        null !== s.id && this.#pt.setAttribute("id", `${s.id}`);
        t.append(this.#pt);
      } else "endMarkedContent" === s.type && (this.#pt = this.#pt.parentNode);
    }
  }
  #Qi(t) {
    const e = document.createElement("span"),
    ...
    this.#Hi.push(e);
    const s = Util.transform(this.#Ui, t.transform);
    let n = Math.atan2(s[1], s[0]);
    const a = this.#Oi[t.fontName];
    ...
    const c = "calc(var(--scale-factor)*",
      u = e.style;
    if (this.#pt === this.#Ii) {
      u.left = `${((100 * h) / this.#ki).toFixed(2)}%`;
      u.top = `${((100 * d) / this.#Di).toFixed(2)}%`;
    } else {
      u.left = `${c}${h.toFixed(2)}px)`;
      u.top = `${c}${d.toFixed(2)}px)`;
    }
    u.fontSize = `${c}${(TextLayer.#ji * o).toFixed(2)}px)`;
    u.fontFamily = r;
    i.fontSize = o;
    ...
    this.#zi.set(e, i);
    this.#Pi.div = e;
    this.#Pi.properties = i;
    this.#Yi(this.#Pi);
    i.hasText && this.#pt.append(e);
    if (i.hasEOL) {
  ...
  static cleanup() {
    if (!(this.#Wi.size > 0)) {
      this.#Gi.clear();
      for (const { canvas: t } of this.#$i.values()) t.remove();
      this.#$i.clear();
    }
  }
  static #Ki(t = null) {
    ...
    if (!e) {
      ...
      this.#$i.set(t, e);
      this.#Vi.set(e, { size: 0, family: "" });
    }
    return e;
  }
  static #Zi(t, e, i) {
    const s = this.#Vi.get(t);
  ...
  static #qi() {
    ...
    this.#ji = t.getBoundingClientRect().height;
    t.remove();
  }
  static #Ji(t, e) {
    const i = this.#Gi.get(t);
    if (i) return i;
    const s = this.#Ki(e);
    s.canvas.width = s.canvas.height = Pt;
    this.#Zi(s, Pt, t);
    ...
    s.strokeStyle = "red";
    s.clearRect(0, 0, Pt, Pt);
    s.strokeText("g", 0, 0);
    let o = s.getImageData(0, 0, Pt, Pt).data;
    r = 0;
    ...
    s.clearRect(0, 0, Pt, Pt);
    s.strokeText("A", 0, Pt);
    o = s.getImageData(0, 0, Pt, Pt).data;
    a = 0;
    for (let t = 0, e = o.length; t < e; t += 4)
      if (o[t] > 0) {
        a = Pt - Math.floor(t / 4 / Pt);
        break;
      }
    s.canvas.width = s.canvas.height = 0;
    const l = a ? a / (a + r) : 0.8;
...
const Dt = 65536,
  ...
  It = e
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        get #y() {
          return (this.#es ||= new Map());
        }
        get #rs() {
          return (this.#as ||= new Map());
        }
        get #os() {
          if (!this.#is) {
            const t = this.#ns.createElement("div"),
              { style: e } = t;
            e.visibility = "hidden";
            e.contain = "strict";
            e.width = e.height = 0;
            ...
            e.top = e.left = 0;
            e.zIndex = -1;
            const i = this.#ns.createElementNS(it, "svg");
            i.setAttribute("width", 0);
            i.setAttribute("height", 0);
            this.#is = this.#ns.createElementNS(it, "defs");
            t.append(i);
            i.append(this.#is);
            this.#ns.body.append(t);
          }
          return this.#is;
        }
        #ls(t) {
        ...
        #hs(t) {
          ...
          return `url(${this.#ts}#${t})`;
        }
        addFilter(t) {
          if (!t) return "none";
          let e = this.#y.get(t);
          if (e) return e;
          const [i, s, n] = this.#ls(t),
          ...
          const r = `g_${this.#ss}_transfer_map_${this.#w++}`,
            o = this.#hs(r);
          this.#y.set(t, o);
          this.#y.set(a, o);
          const l = this.#ds(r);
        ...
        addHCMFilter(t, e) {
          ...
          const l = o.join(","),
            h = `g_${this.#ss}_hcm_filter`,
            d = (n.filter = this.#ds(h));
          this.#cs(l, l, l, d);
          this.#ps(d);
          const getSteps = (t, e) => {
            const i = a[t] / 255,
          ...
          this.#cs(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), d);
          n.url = this.#hs(h);
          return n.url;
        }
        addAlphaFilter(t) {
          ...
          const n = `g_${this.#ss}_alpha_map_${this.#w++}`,
            a = this.#hs(n);
          this.#y.set(t, a);
          this.#y.set(s, a);
          const r = this.#ds(n);
        ...
        addLuminosityFilter(t) {
          ...
          const n = `g_${this.#ss}_luminosity_map_${this.#w++}`,
            a = this.#hs(n);
          this.#y.set(t, a);
          this.#y.set(i, a);
          const r = this.#ds(n);
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          const getSteps = (t, e, i) => {
            ...
            p = `g_${this.#ss}_hcm_${t}_filter`,
            g = (r.filter = this.#ds(p));
          this.#ps(g);
          this.#cs(
            getSteps(c[0], u[0], 5),
            getSteps(c[1], u[1], 5),
        ...
        #ms(t) {
          const e = this.#ns.createElementNS(it, "feColorMatrix");
        ...
        #ds(t) {
          const e = this.#ns.createElementNS(it, "filter");
        ...
        #fs(t, e, i) {
          const s = this.#ns.createElementNS(it, e);
          s.setAttribute("type", "discrete");
          s.setAttribute("tableValues", i);
          t.append(s);
        }
        #cs(t, e, i, s) {
          const n = this.#ns.createElementNS(it, "feComponentTransfer");
          s.append(n);
          this.#fs(n, "feFuncR", t);
          this.#fs(n, "feFuncG", e);
          this.#fs(n, "feFuncB", i);
        ...
        #gs(t, e) {
          const i = this.#ns.createElementNS(it, "feComponentTransfer");
          e.append(i);
          this.#fs(i, "feFuncA", t);
        }
        #us(t) {
          this.#os.style.color = t;
...
function getDocument(t = {}) {
  ...
  const u = t.verbosity,
    p =
      "string" != typeof t.docBaseUrl || isDataScheme(t.docBaseUrl)
        ? null
        : t.docBaseUrl,
    g = "string" == typeof t.cMapUrl ? t.cMapUrl : null,
    m = !1 !== t.cMapPacked,
    f = t.CMapReaderFactory || Rt,
    b = "string" == typeof t.standardFontDataUrl ? t.standardFontDataUrl : null,
    A = t.StandardFontDataFactory || Ft,
    w = !0 !== t.stopAtErrors,
    v =
    ...
    _ =
      "boolean" == typeof t.isImageDecoderSupported
        ...
        : !e && (util_FeatureTest.platform.isFirefox || !globalThis.chrome),
    E = Number.isInteger(t.canvasMaxAreaInBytes) ? t.canvasMaxAreaInBytes : -1,
    S = "boolean" == typeof t.disableFontFace ? t.disableFontFace : e,
    C = !0 === t.fontExtraProperties,
    T = !0 === t.enableXfa,
    M = t.ownerDocument || globalThis.document,
    P = !0 === t.disableRange,
    D = !0 === t.disableStream,
    k = !0 === t.disableAutoFetch,
    R = !0 === t.pdfBug,
    I = t.CanvasFactory || kt,
    F = t.FilterFactory || It,
    L = !0 === t.enableHWA,
    O = h ? h.length : (t.length ?? NaN),
    N = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !e && !S,
    B =
  ...
  setVerbosityLevel(u);
  const H = {
    canvasFactory: new I({ ownerDocument: M, enableHWA: L }),
    filterFactory: new F({ docId: s, ownerDocument: M }),
    cMapReaderFactory: B ? null : new f({ baseUrl: g, isCompressed: m }),
    standardFontDataFactory: B ? null : new A({ baseUrl: b }),
  };
  if (!c) {
  ...
  const z = {
    ...
    U = {
      ...
      pdfBug: R,
      styleElement: null,
      loadingParams: { disableAutoFetch: k, enableXfa: T },
    };
  c.promise
    .then(function () {
      ...
      let l;
      if (h)
        l = new PDFDataTransportStream(h, {
          disableRange: P,
          disableStream: D,
        });
      else if (!a) {
      ...
      return t.then((t) => {
        ...
        const e = new MessageHandler(s, t, c.port),
          n = new WorkerTransport(e, i, l, U, H);
        i._transport = n;
        e.send("Ready", null);
      });
    })
...
class PDFDocumentLoadingTask {
  ...
  constructor() {
    ...
    this._worker = null;
    this.docId = "d" + PDFDocumentLoadingTask.#ss++;
    this.destroyed = !1;
...
class PDFPageProxy {
  ...
  render({
    ...
    const complete = (t) => {
        ...
        (this._maybeCleanupAfterRender || b) && (this.#As = !0);
        this.#vs(!b);
        if (t) {
  ...
  getTextContent(t = {}) {
    if (this._transport._htmlForXfa)
      return this.getXfa().then((t) => XfaText.textContent(t));
  ...
  #vs(t = !1) {
    this.#ws();
    if (!this.#As || this.destroyed) return !1;
    if (t) {
      this.#bs = setTimeout(() => {
        this.#bs = null;
        this.#vs(!1);
...
class LoopbackPort {
  ...
  postMessage(t, e) {
    ...
    this.#xs.then(() => {
      for (const [t] of this.#ys) t.call(this, i);
    });
  }
  addEventListener(t, e, i = null) {
    ...
    if (i?.signal instanceof AbortSignal) {
      ...
      const onAbort = () => this.removeEventListener(t, e);
      s = () => n.removeEventListener("abort", onAbort);
      n.addEventListener("abort", onAbort);
    }
    this.#ys.set(e, s);
  }
  removeEventListener(t, e) {
    const i = this.#ys.get(e);
    i?.();
    this.#ys.delete(e);
  }
  terminate() {
    for (const [, t] of this.#ys) t?.();
    this.#ys.clear();
  }
}
class PDFWorker {
  ...
  constructor({
    ...
    if (e) {
      if (PDFWorker.#Ss?.has(e))
        throw new Error("Cannot use more than one PDFWorker per port.");
      (PDFWorker.#Ss ||= new WeakMap()).set(e, this);
  ...
  destroy() {
    ...
    this._webWorker = null;
    PDFWorker.#Ss?.delete(this._port);
    this._port = null;
...
class WorkerTransport {
  ...
  getRenderingIntent(t, e = p.ENABLE, i = null, s = !1, n = !1) {
    ...
    const f =
      g & o && i instanceof PrintAnnotationStorage ? i : this.annotationStorage;
    switch (e) {
      case p.DISABLE:
        g += d;
        break;
  ...
  destroy() {
    ...
    const t = [];
    for (const e of this.#Ps.values()) t.push(e._destroy());
    this.#Ps.clear();
    this.#Ds.clear();
    this.#ks.clear();
  ...
  setupMessageHandler() {
    ...
    t.on("ReaderHeadersReady", async (t) => {
      ...
      return { isStreamingSupported: i, isRangeSupported: s, contentLength: n };
    });
    ...
    t.on("DocException", (t) => {
      e._capability.reject(wrapReason(t));
    });
    t.on("PasswordRequest", (t) => {
      this.#Rs = Promise.withResolvers();
      try {
        if (!e.onPassword) throw wrapReason(t);
        const updatePassword = (t) => {
          t instanceof Error
            ? this.#Rs.reject(t)
            : this.#Rs.resolve({ password: t });
        };
    ...
    t.on("StartRenderPage", (t) => {
      ...
      this.#Ps.get(t.pageIndex)._startRenderPage(t.transparency, t.cacheKey);
    });
  ...
  getPage(t) {
    ...
    const s = this.messageHandler
      ...
      .then((i) => {
        ...
        i.refStr && this.#ks.set(i.refStr, t);
  ...
  getOptionalContentConfig(t) {
    return this.#Is("GetOptionalContentConfig").then(
      (e) => new OptionalContentConfig(e, t),
    );
  }
  getPermissions() {
  ...
  cachedPageNumber(t) {
    ...
    return this.#ks.get(e) ?? null;
  }
}
const Lt = Symbol("INITIAL_DATA");
class PDFObjects {
  #Fs = Object.create(null);
  #Ls(t) {
    return (this.#Fs[t] ||= { ...Promise.withResolvers(), data: Lt });
  }
  get(t, e = null) {
    if (e) {
      const i = this.#Ls(t);
  ...
  clear() {
    for (const t in this.#Fs) {
      const { data: e } = this.#Fs[t];
      e?.bitmap?.close();
    }
...
class RenderTask {
  ...
  cancel(t = 0) {
    this.#Os.cancel(null, t);
  }
  get separateAnnots() {
    const { separateAnnots: t } = this.#Os.operatorList;
    if (!t) return !1;
    const { annotationCanvasMap: e } = this.#Os;
    return t.form || (t.canvas && e?.size > 0);
  }
}
class InternalRenderTask {
  #Ns = null;
  static #Bs = new WeakSet();
  constructor({
    callback: t,
    params: e,
    objs: i,
  ...
  initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
    ...
    if (this._canvas) {
      if (InternalRenderTask.#Bs.has(this._canvas))
        throw new Error(
          "Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.",
        );
      InternalRenderTask.#Bs.add(this._canvas);
    }
  ...
  cancel(t = null, e = 0) {
    ...
    InternalRenderTask.#Bs.delete(this._canvas);
    this.callback(
      t ||
...
class AnnotationElement {
  ...
  _createContainer(t) {
    ...
    this instanceof WidgetAnnotationElement || (n.tabIndex = Bt);
    const { style: a } = n;
  ...
  _createPopup() {
    const { data: t } = this,
      e = (this.#Us = new PopupAnnotationElement({
        data: {
          color: t.color,
          titleObj: t.titleObj,
  ...
  _getElementsByName(t, e = null) {
    ...
    for (const s of document.getElementsByName(t)) {
      ...
      n !== e && Ht.has(s) && i.push({ id: n, exportValue: t, domElement: s });
    }
    return i;
  }
  show() {
...
class LinkAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    if (t.url) {
      ...
      this.#$s(i, t.attachment, t.attachmentDest);
      s = !0;
    } else if (t.setOCGState) {
      this.#Vs(i, t.setOCGState);
      s = !0;
    } else if (t.dest) {
...
class WidgetAnnotationElement extends AnnotationElement {
  ...
  _setBackgroundColor(t) {
    ...
    t.style.backgroundColor =
      null === e ? "transparent" : Util.makeHexColor(e[0], e[1], e[2]);
  }
  _setTextStyle(t) {
...
class PopupElement {
  ...
  constructor({
    ...
    this.#an = h;
    this.#sn = i;
    this.#in = PDFDateString.toDateObject(n);
    this.trigger = i.flatMap((t) => t.getElementsToTriggerPopup());
    for (const t of this.trigger) {
      t.addEventListener("click", this.#Js);
      t.addEventListener("mouseenter", this.#Ys);
      t.addEventListener("mouseleave", this.#Xs);
      t.classList.add("popupTriggerArea");
    }
    for (const t of i) t.container?.addEventListener("keydown", this.#Ws);
    this.#pt.hidden = !0;
    d && this.#Zs();
  }
  render() {
    if (this.#on) return;
    const t = (this.#on = document.createElement("div"));
    t.className = "popup";
    if (this.#tn) {
      const e = (t.style.outlineColor = Util.makeHexColor(...this.#tn));
      if (
        ...
        t.style.backgroundColor = Util.makeHexColor(
          ...this.#tn.map((t) => Math.floor(e * (255 - t) + t)),
        );
      }
    }
    const e = document.createElement("span");
    ...
    e.append(i);
    ({ dir: i.dir, str: i.textContent } = this.#dn);
    t.append(e);
    if (this.#in) {
      ...
      t.setAttribute(
        "data-l10n-args",
        JSON.stringify({ dateObj: this.#in.valueOf() }),
      );
      e.append(t);
    }
    const s = this.#un;
    if (s) {
      ...
      const e = this._formatContents(this.#en);
      t.append(e);
    }
    this.#pt.append(t);
  }
  ...
  #mn(t) {
    const e = [],
      ...
      s = {
        style: {
          color: this.#gn,
          fontSize: this.#pn ? `calc(${this.#pn}px * var(--scale-factor))` : "",
        },
      };
  ...
  #qs(t) {
    t.altKey ||
      ...
      t.ctrlKey ||
      t.metaKey ||
      (("Enter" === t.key || ("Escape" === t.key && this.#rn)) && this.#Zs());
  }
  ...
  #fn() {
    ...
    const o = Util.normalizeRect([
      ...
      h = o[0] + l,
      d = o[1];
    this.#C = [(100 * (h - s)) / e, (100 * (d - n)) / i];
    const { style: c } = this.#pt;
    c.left = `${this.#C[0]}%`;
    c.top = `${this.#C[1]}%`;
  }
  #Zs() {
...
class LineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      n = (this.#bn = this.svgFactory.createElement("svg:line"));
...
class SquareAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      a = (this.#An = this.svgFactory.createElement("svg:rect"));
...
class CircleAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      s = this.svgFactory.create(e, i, !0),
      n = t.borderStyle.width,
      a = (this.#wn = this.svgFactory.createElement("svg:ellipse"));
...
class PolylineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    o = o.join(" ");
    const l = (this.#vn = this.svgFactory.createElement(this.svgElementName));
...
class InkAnnotationElement extends AnnotationElement {
  ...
  constructor(t) {
    ...
    this.annotationEditorType =
      "InkHighlight" === this.data.it ? g.HIGHLIGHT : g.INK;
  }
  #_n(t, e) {
    switch (t) {
      case 90:
  ...
  render() {
    ...
    const {
      ...
      { transform: a, width: r, height: o } = this.#_n(e, t),
      l = this.svgFactory.create(r, o, !0),
      h = (this.#yn = this.svgFactory.createElement("svg:g"));
    l.append(h);
    ...
    for (let t = 0, e = i.length; t < e; t++) {
      ...
      this.#xn.push(e);
      e.setAttribute("points", i[t].join(","));
      h.append(e);
    }
  ...
  updateEdited(t) {
    ...
    const { thickness: e, points: i, rect: s } = t,
      n = this.#yn;
    e >= 0 && n.setAttribute("stroke-width", e || 1);
    if (i)
      for (let t = 0, e = this.#xn.length; t < e; t++)
        this.#xn[t].setAttribute("points", i[t].join(","));
    if (s) {
      const {
        transform: t,
        width: e,
        height: i,
      } = this.#_n(this.data.rotation, s);
      n.parentElement.setAttribute("viewBox", `0 0 ${e} ${i}`);
...
class FileAttachmentAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    i.addEventListener("dblclick", this.#Sn.bind(this));
    this.#En = i;
    const { isMac: s } = util_FeatureTest.platform;
    t.addEventListener("keydown", (t) => {
      "Enter" === t.key && (s ? t.metaKey : t.ctrlKey) && this.#Sn();
    });
...
class AnnotationLayer {
  ...
  async #Dn(t, e) {
    const i = t.firstChild || t,
      s = (i.id = `${et}${e}`),
      n = await this.#Pn?.getAriaAttributes(s);
    if (n) for (const [t, e] of n) i.setAttribute(t, e);
    this.div.append(t);
    this.#Cn?.moveElementInDOM(this.div, t, i, !1);
  }
  async render(t) {
    ...
    for (const t of e) {
      ...
      await this.#Dn(a, t.id);
      if (i._isEditable) {
        this.#Mn.set(i.data.id, i);
...
class FreeTextEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#pn = t.fontSize || FreeTextEditor._defaultFontSize;
  }
  static initialize(t, e) {
  ...
  get propertiesToUpdate() {
    return [
      [m.FREETEXT_SIZE, this.#pn],
      [m.FREETEXT_COLOR, this.#tn],
    ];
  }
  #Ln(t) {
    const setFontsize = (t) => {
        this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
        this.translate(0, -(t - this.#pn) * this.parentScale);
        this.#pn = t;
        this.#Nn();
      },
      e = this.#pn;
  ...
  #On(t) {
    const setColor = (t) => {
        this.#tn = this.editorDiv.style.color = t;
      },
      e = this.#tn;
    this.addCommands({
  ...
  getInitialTranslation() {
    ...
    return [
      ...
      -(FreeTextEditor._internalPadding + this.#pn) * t,
    ];
  }
  rebuild() {
    if (this.parent) {
  ...
  enableEditMode() {
    ...
    const t = this._uiManager.combinedSignal(this.#Fn);
  ...
  render() {
    ...
    i.fontSize = `calc(${this.#pn}px * var(--scale-factor))`;
    i.color = this.#tn;
  ...
  editorDivPaste(t) {
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      if (t !== this.editorDiv) {
        let e = l;
        for (const i of this.editorDiv.childNodes)
          i !== t ? e.push(FreeTextEditor.#Hn(i)) : (e = h);
      }
  ...
  static async deserialize(t, e, i) {
    ...
    n.#pn = t.fontSize;
    n.#tn = Util.makeHexColor(...t.color);
    n.#Rn = FreeTextEditor.#Un(t.value);
  ...
  serialize(t = !1) {
    ...
    if (t) return n;
    if (this.annotationElementId && !this.#$n(n)) return null;
  ...
  renderAnnotationElement(t) {
    ...
    t.updateEdited({ rect: this.getRect(s, s), popupContent: this.#Rn });
    return e;
  }
  resetAnnotationElement(t) {
...
class FreeDrawOutliner {
  ...
  static #sa = 8;
  static #na = 2;
  static #aa = FreeDrawOutliner.#sa + FreeDrawOutliner.#na;
  constructor({ x: t, y: e }, i, s, n, a, r = 0) {
    this.#Vn = i;
    this.#ea = n * s;
    this.#qn = a;
    this.#Kn.set([NaN, NaN, NaN, NaN, t, e], 6);
    this.#Wn = r;
    this.#Zn = FreeDrawOutliner.#sa * s;
    this.#Jn = FreeDrawOutliner.#aa * s;
    this.#ta = s;
    this.#ia.push(t, e);
  }
  isEmpty() {
  ...
  #ra() {
    const t = this.#Kn.subarray(4, 6),
      e = this.#Kn.subarray(16, 18),
      [i, s, n, a] = this.#Vn;
    return [
      (this.#Yn + (t[0] - e[0]) / 2 - i) / n,
      (this.#Qn + (t[1] - e[1]) / 2 - s) / a,
      (this.#Yn + (e[0] - t[0]) / 2 - i) / n,
      (this.#Qn + (e[1] - t[1]) / 2 - s) / a,
    ];
  }
  add({ x: t, y: e }) {
    this.#Yn = t;
    this.#Qn = e;
    const [i, s, n, a] = this.#Vn;
    let [r, o, l, h] = this.#Kn.subarray(8, 12);
    const d = t - l,
      c = e - h,
      u = Math.hypot(d, c);
    if (u < this.#Jn) return !1;
    const p = u - this.#Zn,
      g = p / u,
      m = g * d,
      f = g * c;
    ...
    this.#Kn.set([l + v, h + y], 4);
    this.#Kn.set(this.#Kn.subarray(14, 18), 12);
    this.#Kn.set([l - v, h - y], 16);
    if (isNaN(this.#Kn[6])) {
      if (0 === this.#Xn.length) {
        this.#Kn.set([r + v, o + y], 2);
        this.#Xn.push(NaN, NaN, NaN, NaN, (r + v - i) / n, (o + y - s) / a);
        this.#Kn.set([r - v, o - y], 14);
        this.#jn.push(NaN, NaN, NaN, NaN, (r - v - i) / n, (o - y - s) / a);
      }
      this.#Kn.set([b, A, r, o, l, h], 6);
      return !this.isEmpty();
    }
    this.#Kn.set([b, A, r, o, l, h], 6);
    if (Math.abs(Math.atan2(A - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
      [r, o, l, h] = this.#Kn.subarray(2, 6);
      this.#Xn.push(
        NaN,
        NaN,
        NaN,
      ...
      [r, o, b, A] = this.#Kn.subarray(14, 18);
      this.#jn.push(
        NaN,
        NaN,
        NaN,
    ...
    [b, A, r, o, l, h] = this.#Kn.subarray(0, 6);
    this.#Xn.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
    ...
    [l, h, r, o, b, A] = this.#Kn.subarray(12, 18);
    this.#jn.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
  ...
  #oa() {
    const [t, e, i, s] = this.#Vn,
      [n, a, r, o] = this.#ra();
    return `M${(this.#Kn[2] - t) / i} ${(this.#Kn[3] - e) / s} L${(this.#Kn[4] - t) / i} ${(this.#Kn[5] - e) / s} L${n} ${a} L${r} ${o} L${(this.#Kn[16] - t) / i} ${(this.#Kn[17] - e) / s} L${(this.#Kn[14] - t) / i} ${(this.#Kn[15] - e) / s} Z`;
  }
  #ha(t) {
    const e = this.#jn;
    t.push(`L${e[4]} ${e[5]} Z`);
  ...
  #la(t) {
    const [e, i, s, n] = this.#Vn,
      a = this.#Kn.subarray(4, 6),
      r = this.#Kn.subarray(16, 18),
      [o, l, h, d] = this.#ra();
    t.push(
      `L${(a[0] - e) / s} ${(a[1] - i) / n} L${o} ${l} L${h} ${d} L${(r[0] - e) / s} ${(r[1] - i) / n}`,
    );
  }
  newFreeDrawOutline(t, e, i, s, n, a) {
    return new FreeDrawOutline(t, e, i, s, n, a);
  }
  getOutlines() {
    const t = this.#Xn,
      e = this.#jn,
      i = this.#Kn,
      [s, n, a, r] = this.#Vn,
      o = new Float32Array((this.#ia?.length ?? 0) + 2);
    for (let t = 0, e = o.length - 2; t < e; t += 2) {
      o[t] = (this.#ia[t] - s) / a;
      o[t + 1] = (this.#ia[t + 1] - n) / r;
    }
    o[o.length - 2] = (this.#Yn - s) / a;
    o[o.length - 1] = (this.#Qn - n) / r;
    if (isNaN(i[6]) && !this.isEmpty()) return this.#da(o);
    const l = new Float32Array(this.#Xn.length + 24 + this.#jn.length);
    let h = t.length;
    for (let e = 0; e < h; e += 2)
      if (isNaN(t[e])) l[e] = l[e + 1] = NaN;
      else {
        l[e] = t[e];
        l[e + 1] = t[e + 1];
      }
  ...
  #ua(t, e) {
    const i = this.#jn;
    t.set([NaN, NaN, NaN, NaN, i[4], i[5]], e);
    return e + 6;
  }
  #ca(t, e) {
    const i = this.#Kn.subarray(4, 6),
      s = this.#Kn.subarray(16, 18),
      [n, a, r, o] = this.#Vn,
      [l, h, d, c] = this.#ra();
    t.set(
      [
...
class FreeDrawOutline extends Outline {
  ...
  toSVGPath() {
    const t = [`M${this.#ga[4]} ${this.#ga[5]}`];
    for (let e = 6, i = this.#ga.length; e < i; e += 6)
      isNaN(this.#ga[e])
        ? t.push(`L${this.#ga[e + 4]} ${this.#ga[e + 5]}`)
        : t.push(
            `C${this.#ga[e]} ${this.#ga[e + 1]} ${this.#ga[e + 2]} ${this.#ga[e + 3]} ${this.#ga[e + 4]} ${this.#ga[e + 5]}`,
          );
    t.push("Z");
    return t.join(" ");
  }
  serialize([t, e, i, s], n) {
    ...
    switch (n) {
      case 0:
        o = Outline._rescale(this.#ga, t, s, a, -r);
        l = Outline._rescale(this.#ia, t, s, a, -r);
        break;
      case 90:
        o = Outline._rescaleAndSwap(this.#ga, t, e, a, r);
        l = Outline._rescaleAndSwap(this.#ia, t, e, a, r);
        break;
      case 180:
        o = Outline._rescale(this.#ga, i, e, -a, r);
        l = Outline._rescale(this.#ia, i, e, -a, r);
        break;
      case 270:
        o = Outline._rescaleAndSwap(this.#ga, i, s, -a, -r);
        l = Outline._rescaleAndSwap(this.#ia, i, s, -a, -r);
    }
  ...
  newOutliner(t, e, i, s, n, a = 0) {
    return new FreeDrawOutliner(t, e, i, s, n, a);
  }
  getNewOutline(t, e) {
    const [i, s, n, a] = this.#pa,
      [r, o, l, h] = this.#Vn,
      d = n * l,
      c = a * h,
      u = i * l + r,
      p = s * h + o,
      g = this.newOutliner(
        { x: this.#ia[0] * d + u, y: this.#ia[1] * c + p },
        this.#Vn,
        this.#ta,
        t,
        this.#qn,
    ...
    for (let t = 2; t < this.#ia.length; t += 2)
      g.add({ x: this.#ia[t] * d + u, y: this.#ia[t + 1] * c + p });
...
class HighlightOutliner {
  ...
  constructor(t, e = 0, i = 0, s = !0) {
    ...
    const h = a - n + 2 * i,
      ...
      p = this.#ba.at(s ? -1 : -2),
      g = [p[0], p[2]];
    for (const t of this.#ba) {
      const [e, i, s] = t;
      t[0] = (e - c) / h;
      t[1] = (i - u) / d;
      t[2] = (s - u) / d;
    }
    this.#Vn = new Float32Array([c, u, h, d]);
    this.#fa = g;
  }
  getOutlines() {
    this.#ba.sort((t, e) => t[0] - e[0] || t[1] - e[1] || t[2] - e[2]);
    const t = [];
  ...
  #xa(t) {
    ...
    return new HighlightOutline(s, this.#Vn, this.#fa);
  }
  #_a(t) {
    const e = this.#Aa;
    let i = 0,
  ...
  #va([, t, e]) {
    const i = this.#_a(t);
    this.#Aa.splice(i, 0, [t, e]);
  }
  #ya([, t, e]) {
    const i = this.#_a(t);
    for (let s = i; s < this.#Aa.length; s++) {
      const [i, n] = this.#Aa[s];
      if (i !== t) break;
      if (i === t && n === e) {
        this.#Aa.splice(s, 1);
...
class FreeHighlightOutliner extends FreeDrawOutliner {
  newFreeDrawOutline(t, e, i, s, n, a) {
    return new FreeHighlightOutline(t, e, i, s, n, a);
  }
}
class FreeHighlightOutline extends FreeDrawOutline {
  newOutliner(t, e, i, s, n, a = 0) {
    return new FreeHighlightOutliner(t, e, i, s, n, a);
  }
}
class ColorPicker {
  #Sa = null;
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    ...
    this.#Ta =
      t?.color || this.#m?.highlightColors.values().next().value || "#FFFF98";
    ColorPicker.#Fa ||= Object.freeze({
  ...
  renderButton() {
    const t = (this.#Sa = document.createElement("button"));
    ...
    t.addEventListener("click", this.#La.bind(this), { signal: e });
    t.addEventListener("keydown", this.#qs.bind(this), { signal: e });
    const i = (this.#Ca = document.createElement("span"));
    i.className = "swatch";
    i.setAttribute("aria-hidden", !0);
    i.style.backgroundColor = this.#Ta;
    t.append(i);
    return t;
  }
  renderMainDropdown() {
    const t = (this.#Ma = this.#Oa());
  ...
  #Oa() {
    ...
    for (const [i, s] of this.#m.highlightColors) {
      ...
      n.title = i;
      n.setAttribute("data-l10n-id", ColorPicker.#Fa[i]);
      const a = document.createElement("span");
      n.append(a);
      a.className = "swatch";
      a.style.backgroundColor = s;
      n.setAttribute("aria-selected", s === this.#Ta);
      n.addEventListener("click", this.#Na.bind(this, s), { signal: e });
      t.append(n);
    }
    t.addEventListener("keydown", this.#qs.bind(this), { signal: e });
    return t;
  ...
  #Na(t, e) {
    e.stopPropagation();
    this.#ka.dispatch("switchannotationeditorparams", {
      source: this,
      type: this.#Ia,
      value: t,
    });
  ...
  _moveToNext(t) {
    this.#Ba
      ? t.target !== this.#Sa
        ...
        : this.#Ma.firstChild?.focus()
      : this.#La(t);
  }
  _moveToPrevious(t) {
    if (t.target !== this.#Ma?.firstChild && t.target !== this.#Sa) {
      this.#Ba || this.#La(t);
      t.target.previousSibling?.focus();
    } else this.#Ba && this._hideDropdownFromKeyboard();
  }
  _moveToBeginning(t) {
    this.#Ba ? this.#Ma.firstChild?.focus() : this.#La(t);
  }
  _moveToEnd(t) {
    this.#Ba ? this.#Ma.lastChild?.focus() : this.#La(t);
  }
  #qs(t) {
  ...
  #La(t) {
    ...
    if (!this.#Ra) {
      ...
      window.addEventListener("pointerdown", this.#h.bind(this), {
        signal: this.#m.combinedSignal(this.#Ra),
      });
    }
    if (this.#Ma) {
    ...
    const e = (this.#Ma = this.#Oa());
    this.#Sa.append(e);
  }
  #h(t) {
    this.#Ma?.contains(t.target) || this.hideDropdown();
  }
  hideDropdown() {
  ...
  _hideDropdownFromKeyboard() {
    if (!this.#Da)
      if (this.#Ba) {
        this.hideDropdown();
        this.#Sa.focus({ preventScroll: !0, focusVisible: this.#Pa });
      } else this.#a?.unselect();
  }
  updateColor(t) {
    this.#Ca && (this.#Ca.style.backgroundColor = t);
    if (!this.#Ma) return;
    const e = this.#m.highlightColors.values();
    for (const i of this.#Ma.children)
...
class HighlightEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#ea = t.thickness || HighlightEditor._defaultThickness;
    this.#Ka = t.opacity || HighlightEditor._defaultOpacity;
    this.#Ua = t.boxes || null;
    this.#Ja = t.methodOfCreation || "";
    this.#Qa = t.text || "";
    this._isDraggable = !1;
    if (t.highlightId > -1) {
      this.#Xa = !0;
      ...
      this.#Ha = t.anchorNode;
      this.#za = t.anchorOffset;
      this.#Va = t.focusNode;
      this.#ja = t.focusOffset;
      this.#er();
      this.#tr();
  ...
  get telemetryInitialData() {
    return {
      action: "added",
      type: this.#Xa ? "free_highlight" : "highlight",
      color: this._uiManager.highlightColorNames.get(this.color),
      thickness: this.#ea,
      methodOfCreation: this.#Ja,
    };
  }
  get telemetryFinalData() {
    return {
  ...
  #er() {
    const t = new HighlightOutliner(this.#Ua, 0.001);
    this.#qa = t.getOutlines();
    [this.x, this.y, this.width, this.height] = this.#qa.box;
    const e = new HighlightOutliner(
      this.#Ua,
      0.0025,
      0.001,
    ...
    const { lastPoint: i } = this.#$a;
    this.#fa = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height];
  }
  #Za({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    this.#qa = t;
    this.#$a = t.getNewOutline(this.#ea / 2 + 1.5, 0.0025);
    if (e >= 0) {
      this.#w = e;
      this.#Ga = i;
      this.parent.drawLayer.finalizeDraw(e, {
        bbox: t.box,
        path: { d: t.toSVGPath() },
      });
      this.#Ya = this.parent.drawLayer.drawOutline(
        {
      ...
      this.parent.drawLayer.updateProperties(this.#w, {
        bbox: HighlightEditor.#ir(
          this.#qa.box,
          (e - this.rotation + 360) % 360,
        ),
        path: { d: t.toSVGPath() },
      });
      this.parent.drawLayer.updateProperties(this.#Ya, {
        bbox: HighlightEditor.#ir(this.#$a.box, e),
        path: { d: this.#$a.toSVGPath() },
      });
    }
    const [s, n, a, r] = t.box;
    ...
    const { lastPoint: o } = this.#$a;
    this.#fa = [(o[0] - s) / a, (o[1] - n) / r];
  }
  static initialize(t, e) {
    AnnotationEditor.initialize(t, e);
  ...
  get propertiesToUpdate() {
    return [
      ...
      [m.HIGHLIGHT_THICKNESS, this.#ea || HighlightEditor._defaultThickness],
      [m.HIGHLIGHT_FREE, this.#Xa],
    ];
  }
  #On(t) {
  ...
  getRect(t, e) {
    return super.getRect(t, e, this.#ar());
  }
  onceAdded(t) {
  ...
  #nr(t) {
    if (!this.#Xa) return;
    this.#Za({ highlightOutlines: this.#qa.getNewOutline(t / 2) });
    this.fixAndSetPosition();
  ...
  #tr(t = this.parent) {
    if (null === this.#w) {
      ({ id: this.#w, clipPathId: this.#Ga } = t.drawLayer.draw(
        {
          bbox: this.#qa.box,
          root: {
            viewBox: "0 0 1 1",
            fill: this.color,
            "fill-opacity": this.#Ka,
          },
          rootClass: { highlight: !0, free: this.#Xa },
          path: { d: this.#qa.toSVGPath() },
        },
        !1,
        !0,
      ));
      this.#Ya = t.drawLayer.drawOutline(
        {
          rootClass: { highlightOutline: !0, free: this.#Xa },
          bbox: this.#$a.box,
          path: { d: this.#$a.toSVGPath() },
        },
        this.#Xa,
  ...
  rotate(t) {
    ...
    if (this.#Xa) {
      ...
      i = HighlightEditor.#ir(this.#qa.box, t);
    } else
      i = HighlightEditor.#ir([this.x, this.y, this.width, this.height], t);
    e.updateProperties(this.#w, { bbox: i, root: { "data-main-rotation": t } });
    e.updateProperties(this.#Ya, {
      bbox: HighlightEditor.#ir(this.#$a.box, t),
  ...
  render() {
    ...
    const t = super.render();
    if (this.#Qa) {
      t.setAttribute("aria-label", this.#Qa);
      t.setAttribute("role", "mark");
    }
    this.#Xa
      ? t.classList.add("free")
      : this.div.addEventListener("keydown", this.#or.bind(this), {
          signal: this._uiManager._signal,
        });
    const e = (this.#Wa = document.createElement("div"));
    t.append(e);
    e.setAttribute("aria-hidden", "true");
    e.className = "internal";
    e.style.clipPath = this.#Ga;
    const [i, s] = this.parentDimensions;
  ...
  #lr(t) {
    ...
    t ? e.setPosition(this.#Ha, this.#za) : e.setPosition(this.#Va, this.#ja);
  }
  select() {
    super.select();
    this.#Ya &&
  ...
  #dr(t) {
    return this.#qa.serialize(t, this.#ar());
  }
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    ...
    i.addEventListener("pointermove", this.#ur.bind(this, t), { signal: d });
  ...
  static async deserialize(t, e, i) {
    ...
    if (a) {
      ...
      const t = r[0],
        i = { x: t[0] - c, y: d - (t[1] - u) },
        s = new FreeHighlightOutliner(i, [0, 0, h, d], 1, l.#ea / 2, !0, 0.001);
  ...
  serialize(t = !1) {
    ...
    if (this.annotationElementId && !this.#$n(s)) return null;
...
class DrawingOptions {
  ...
  updateProperties(t) {
    if (t) for (const [e, i] of Object.entries(t)) this.updateProperty(e, i);
  }
...
class DrawingEditor extends AnnotationEditor {
  ...
  constructor(t) {
    super(t);
    this.#mr = t.mustBeCommitted || !1;
    if (t.drawOutlines) {
      this.#_r(t);
      this.#tr();
    }
  }
  #_r({ drawOutlines: t, drawId: e, drawingOptions: i }) {
    this.#gr = t;
    this._drawingOptions ||= i;
    if (e >= 0) {
      this._drawId = e;
      this.parent.drawLayer.finalizeDraw(e, t.defaultProperties);
    } else this._drawId = this.#Er(t, this.parent);
    this.#Sr(t.box);
  }
  #Er(t, e) {
    const { id: i } = e.drawLayer.draw(
  ...
  static _mergeSVGProperties(t, e) {
    ...
    for (const [s, n] of Object.entries(e))
      i.has(s) ? Object.assign(t[s], n) : (t[s] = n);
    return t;
  }
  ...
  static updateDefaultParams(t, e) {
    ...
    if (this._currentParent) {
      DrawingEditor.#fr.updateProperty(i, e);
  ...
  static get defaultPropertiesToUpdate() {
    ...
    for (const [i, s] of this.typesMap) t.push([i, e[s]]);
    return t;
  }
  get propertiesToUpdate() {
    const t = [],
      { _drawingOptions: e } = this;
    for (const [i, s] of this.constructor.typesMap) t.push([i, e[s]]);
    return t;
  }
  _updateProperty(t, e, i) {
    const s = this._drawingOptions,
      n = s[e],
      setter = (t) => {
        s.updateProperty(e, t);
        const i = this.#gr.updateProperty(e, t);
        i && this.#Sr(i);
  ...
  _onResizing() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#gr.getPathResizingSVGProperties(this.#Cr()),
        { bbox: this.#Tr() },
      ),
    );
  }
  _onResized() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#gr.getPathResizedSVGProperties(this.#Cr()),
        { bbox: this.#Tr() },
      ),
    );
  }
  ...
  _onTranslated() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#gr.getPathTranslatedSVGProperties(
          this.#Cr(),
  ...
  #tr(t = this.parent) {
    if (null === this._drawId || this.parent !== t)
      if (null === this._drawId) {
        ...
        this._drawId = this.#Er(this.#gr, t);
      } else this.parent.drawLayer.updateParent(this._drawId, t.drawLayer);
  }
  #Mr([t, e, i, s]) {
    const {
    ...
    switch (r) {
      case 90:
        return [e, 1 - t, i * (a / n), s * (n / a)];
      case 180:
        return [1 - t, 1 - e, i, s];
      case 270:
        return [1 - e, t, i * (a / n), s * (n / a)];
      default:
        return [t, e, i, s];
    }
  }
  #Cr() {
    ...
    switch (r) {
      case 90:
        return [1 - e, t, i * (n / a), s * (a / n)];
      case 180:
        return [1 - t, 1 - e, i, s];
      case 270:
        return [e, 1 - t, i * (n / a), s * (a / n)];
      default:
        return [t, e, i, s];
    }
  }
  #Sr(t) {
    [this.x, this.y, this.width, this.height] = this.#Mr(t);
    if (this.div) {
      this.fixAndSetPosition();
      const [t, e] = this.parentDimensions;
  ...
  #Tr() {
    ...
    switch ((4 * n + a) / 90) {
      ...
      case 3:
        return [e, 1 - t - i, s, i];
      case 4:
        return [t, e - i * (r / o), s * (o / r), i * (r / o)];
      case 5:
        return [1 - e, t, i * (r / o), s * (o / r)];
      case 6:
        return [1 - t - s * (o / r), 1 - e, s * (o / r), i * (r / o)];
      case 7:
        return [e - i * (r / o), 1 - t - s * (o / r), i * (r / o), s * (o / r)];
      case 8:
        return [t - i, e - s, i, s];
      case 9:
        return [1 - e, t - i, s, i];
      ...
      case 11:
        return [e - s, 1 - t, s, i];
      case 12:
        return [t - s * (o / r), e, s * (o / r), i * (r / o)];
      case 13:
        return [1 - e - i * (r / o), t - s * (o / r), i * (r / o), s * (o / r)];
      case 14:
        return [1 - t, 1 - e - i * (r / o), s * (o / r), i * (r / o)];
      case 15:
        return [e, 1 - t, i * (r / o), s * (o / r)];
      default:
        return [t, e, i, s];
    }
  }
  ...
  onScaleChanging() {
    this.parent &&
      this.#Sr(
        this.#gr.updateParentDimensions(
          this.parentDimensions,
          this.parent.scale,
        ),
      );
  ...
  static startDrawing(t, e, i, s) {
    ...
    if (DrawingEditor.#vr && DrawingEditor.#vr !== l) return;
    const {
        viewport: { rotation: h },
      } = t,
      { width: d, height: c } = n.getBoundingClientRect(),
      u = (DrawingEditor.#br = new AbortController()),
    ...
    window.addEventListener(
      "pointerup",
      (t) => {
        DrawingEditor.#wr === t.pointerId
          ? this._endDraw(t)
          : DrawingEditor.#yr?.delete(t.pointerId);
      },
      { signal: p },
    );
    window.addEventListener(
    ...
    window.addEventListener(
      "pointerdown",
      (t) => {
        if (DrawingEditor.#vr === t.pointerType) {
          (DrawingEditor.#yr ||= new Set()).add(t.pointerId);
          if (DrawingEditor.#fr.isCancellable()) {
            DrawingEditor.#fr.removeLastElement();
            DrawingEditor.#fr.isEmpty()
    ...
    window.addEventListener("contextmenu", noContextMenu, { signal: p });
    n.addEventListener("pointermove", this._drawMove.bind(this), { signal: p });
    n.addEventListener(
      "touchmove",
      (t) => {
        t.timeStamp === DrawingEditor.#xr && stopEvent(t);
      },
      { signal: p },
    );
    t.toggleDrawing();
    ...
    if (DrawingEditor.#fr)
      t.drawLayer.updateProperties(
        this._currentDrawId,
        DrawingEditor.#fr.startNew(a, r, d, c, h),
      );
    else {
      e.updateUIForDefaultProperties(this);
      DrawingEditor.#fr = this.createDrawerInstance(a, r, d, c, h);
      DrawingEditor.#Ar = this.getDefaultDrawingOptions();
      this._currentParent = t;
      ({ id: this._currentDrawId } = t.drawLayer.draw(
        this._mergeSVGProperties(
          DrawingEditor.#Ar.toSVGProperties(),
          DrawingEditor.#fr.defaultSVGProperties,
        ),
        !0,
        !1,
      ));
  ...
  static _drawMove(t) {
    DrawingEditor.#xr = -1;
    if (!DrawingEditor.#fr) return;
    const { offsetX: e, offsetY: i, pointerId: s } = t;
    if (DrawingEditor.#wr === s)
      if (DrawingEditor.#yr?.size >= 1) this._endDraw(t);
      else {
        this._currentParent.drawLayer.updateProperties(
          this._currentDrawId,
          DrawingEditor.#fr.add(e, i),
        );
        DrawingEditor.#xr = t.timeStamp;
        stopEvent(t);
      }
  }
  static _cleanup(t) {
    if (t) {
      ...
      DrawingEditor.#fr = null;
      DrawingEditor.#Ar = null;
      DrawingEditor.#vr = null;
      DrawingEditor.#xr = NaN;
    }
    if (DrawingEditor.#br) {
      DrawingEditor.#br.abort();
      DrawingEditor.#br = null;
      DrawingEditor.#wr = NaN;
      DrawingEditor.#yr = null;
    }
  }
  static _endDraw(t) {
    ...
    if (e) {
      ...
      t &&
        e.drawLayer.updateProperties(
          this._currentDrawId,
          DrawingEditor.#fr.end(t.offsetX, t.offsetY),
        );
      if (this.supportMultipleDrawings) {
        const t = DrawingEditor.#fr,
  ...
  static endDrawing(t) {
    ...
    if (!e) return null;
    e.toggleDrawing(!0);
    e.cleanUndoStack(m.DRAW_STEP);
    if (!DrawingEditor.#fr.isEmpty()) {
      const {
          pageDimensions: [i, s],
          scale: n,
        } = e,
        a = e.createAndAddNewEditor({ offsetX: 0, offsetY: 0 }, !1, {
          ...
          drawOutlines: DrawingEditor.#fr.getOutlines(
            i * n,
            s * n,
            n,
            this._INNER_MARGIN,
          ),
          drawingOptions: DrawingEditor.#Ar,
          mustBeCommitted: !t,
        });
      this._cleanup(!0);
      return a;
  ...
  serializeDraw(t) {
    const [e, i] = this.pageTranslation,
      [s, n] = this.pageDimensions;
    return this.#gr.serialize([e, i, s, n], t);
  }
  renderAnnotationElement(t) {
    t.updateEdited({ rect: this.getRect(0, 0) });
    return null;
...
class InkDrawOutliner {
  ...
  constructor(t, e, i, s, n, a) {
    ...
    this.#ea = a;
    [t, e] = this.#Fr(t, e);
    const r = (this.#bn = [NaN, NaN, NaN, NaN, t, e]);
    this.#ia = [t, e];
    this.#Pr = [{ line: r, points: this.#ia }];
    this.#Kn.set(r, 0);
  }
  updateProperty(t, e) {
    "stroke-width" === t && (this.#ea = e);
  }
  #Fr(t, e) {
    return Outline._normalizePoint(t, e, this.#Rr, this.#Ir, this.#Fi);
  }
  isEmpty() {
  ...
  add(t, e) {
    [t, e] = this.#Fr(t, e);
    const [i, s, n, a] = this.#Kn.subarray(2, 6),
      r = t - n,
      o = e - a;
    if (Math.hypot(this.#Rr * r, this.#Ir * o) <= 2) return null;
    this.#ia.push(t, e);
    if (isNaN(i)) {
      this.#Kn.set([n, a, t, e], 2);
      this.#bn.push(NaN, NaN, NaN, NaN, t, e);
      return { path: { d: this.toSVGPath() } };
    }
    isNaN(this.#Kn[0]) && this.#bn.splice(6, 6);
    this.#Kn.set([i, s, n, a, t, e], 0);
    this.#bn.push(...Outline.createBezierPoints(i, s, n, a, t, e));
    return { path: { d: this.toSVGPath() } };
  }
  end(t, e) {
    const i = this.add(t, e);
    return (
      i || (2 === this.#ia.length ? { path: { d: this.toSVGPath() } } : null)
    );
  }
  startNew(t, e, i, s, n) {
    this.#Rr = i;
    ...
    this.#Fi = n;
    [t, e] = this.#Fr(t, e);
    const a = (this.#bn = [NaN, NaN, NaN, NaN, t, e]);
    this.#ia = [t, e];
    const r = this.#Pr.at(-1);
    if (r) {
      r.line = new Float32Array(r.line);
      r.points = new Float32Array(r.points);
    }
    this.#Pr.push({ line: a, points: this.#ia });
    this.#Kn.set(a, 0);
    this.#kr = 0;
    this.toSVGPath();
    return null;
  ...
  setLastElement(t) {
    if (!this.#Pr) return this.#Ea.setLastElement(t);
    this.#Pr.push(t);
    this.#bn = t.line;
    this.#ia = t.points;
    this.#kr = 0;
  ...
  removeLastElement() {
    ...
    this.#Pr.pop();
    this.#Dr = "";
    for (let t = 0, e = this.#Pr.length; t < e; t++) {
      const { line: e, points: i } = this.#Pr[t];
      this.#bn = e;
      this.#ia = i;
      this.#kr = 0;
      this.toSVGPath();
  ...
  toSVGPath() {
    const t = Outline.svgRound(this.#bn[4]),
      e = Outline.svgRound(this.#bn[5]);
    if (2 === this.#ia.length) {
      this.#Dr = `${this.#Dr} M ${t} ${e} Z`;
      return this.#Dr;
    }
    if (this.#ia.length <= 6) {
      const i = this.#Dr.lastIndexOf("M");
      this.#Dr = `${this.#Dr.slice(0, i)} M ${t} ${e}`;
      this.#kr = 6;
    }
    if (4 === this.#ia.length) {
      const t = Outline.svgRound(this.#bn[10]),
        e = Outline.svgRound(this.#bn[11]);
      this.#Dr = `${this.#Dr} L ${t} ${e}`;
      this.#kr = 12;
      return this.#Dr;
    }
    const i = [];
    ...
    for (let t = this.#kr, e = this.#bn.length; t < e; t += 6) {
      const [e, s, n, a, r, o] = this.#bn.slice(t, t + 6).map(Outline.svgRound);
  ...
  getOutlines(t, e, i, s) {
    const n = this.#Pr.at(-1);
    n.line = new Float32Array(n.line);
    n.points = new Float32Array(n.points);
    this.#Ea.build(this.#Pr, t, e, i, this.#Fi, this.#ea, s);
    this.#Kn = null;
    this.#bn = null;
    this.#Pr = null;
    this.#Dr = null;
...
class InkDrawOutline extends Outline {
  ...
  toSVGPath() {
    const t = [];
    for (const { line: e } of this.#Pr) {
      t.push(`M${Outline.svgRound(e[4])} ${Outline.svgRound(e[5])}`);
      if (6 !== e.length)
        if (12 !== e.length)
        ...
        else t.push(`L${Outline.svgRound(e[10])} ${Outline.svgRound(e[11])}`);
      else t.push("Z");
    }
    return t.join("");
  }
  serialize([t, e, i, s], n) {
    ...
    for (const { line: t, points: e } of this.#Pr) {
      a.push(w(t, c, u, p, g, n ? new Array(t.length) : null));
      r.push(w(e, c, u, p, g, n ? new Array(e.length) : null));
    }
    return { lines: a, points: r, rect: [m, f, b, A] };
  }
  static deserialize(
    t,
    e,
    ...
    s,
    n,
    { paths: { lines: a, points: r }, rotation: o, thickness: l },
  ) {
    const h = [];
    let d, c, u, p, g;
    switch (o) {
    ...
    if (!a) {
      ...
      for (const t of r) {
        ...
        for (let a = 4; a < e; a += 2) {
          const e = t[a],
            l = t[a + 1];
          i.set(Outline.createBezierPoints(s, n, r, o, e, l), 3 * (a - 2));
          [s, n, r, o] = [r, o, e, l];
        }
      }
    }
    ...
    const m = new InkDrawOutline();
    m.build(h, i, s, 1, o, l, n);
    return m;
  }
  #Hr(t = this.#ea) {
    const e = this.#Wn + (t / 2) * this.#Or;
    return this.#Fi % 180 == 0
      ? [e / this.#Rr, e / this.#Ir]
      : [e / this.#Ir, e / this.#Rr];
  }
  #Br() {
    const [t, e, i, s] = this.#pa,
      [n, a] = this.#Hr(0);
    return [t + n, e + a, i - 2 * n, s - 2 * a];
  }
  #Nr() {
    const t = (this.#pa = new Float32Array([1 / 0, 1 / 0, -1 / 0, -1 / 0]));
    for (const { line: e } of this.#Pr) {
      if (e.length <= 12) {
        for (let i = 4, s = e.length; i < s; i += 6) {
          const [s, n] = e.subarray(i, i + 2);
          t[0] = Math.min(t[0], s);
          t[1] = Math.min(t[1], n);
          t[2] = Math.max(t[2], s);
          t[3] = Math.max(t[3], n);
      ...
      for (let n = 6, a = e.length; n < a; n += 6) {
        const [a, r, o, l, h, d] = e.subarray(n, n + 6);
        Util.bezierBoundingBox(i, s, a, r, o, l, h, d, t);
        i = h;
        s = d;
      }
    }
    const [e, i] = this.#Hr();
    t[0] = Math.min(1, Math.max(0, t[0] - e));
    t[1] = Math.min(1, Math.max(0, t[1] - i));
    t[2] = Math.min(1, Math.max(0, t[2] + e));
    t[3] = Math.min(1, Math.max(0, t[3] + i));
    t[2] -= t[0];
    t[3] -= t[1];
  }
  get box() {
  ...
  updateProperty(t, e) {
    return "stroke-width" === t ? this.#sr(e) : null;
  }
  #sr(t) {
    const [e, i] = this.#Hr();
    this.#ea = t;
  ...
  get defaultProperties() {
    ...
    return {
      ...
      path: {
        "transform-origin": `${Outline.svgRound(t)} ${Outline.svgRound(e)}`,
      },
    };
  }
  get rotationTransform() {
    ...
    return `matrix(${i} ${s} ${n} ${a} ${Outline.svgRound(r)} ${Outline.svgRound(o)})`;
  }
  getPathResizingSVGProperties([t, e, i, s]) {
    const [n, a] = this.#Hr(),
      [r, o, l, h] = this.#pa;
    if (
      Math.abs(l - n) <= Outline.PRECISION ||
      Math.abs(h - a) <= Outline.PRECISION
    ) {
      const n = t + i / 2 - (r + l / 2),
        a = e + s / 2 - (o + h / 2);
      return {
    ...
    return {
      path: {
        ...
        transform: `${this.rotationTransform} scale(${u} ${p}) translate(${Outline.svgRound(n)} ${Outline.svgRound(a)}) scale(${d} ${c}) translate(${Outline.svgRound(-n)} ${Outline.svgRound(-a)})`,
      },
    };
  }
  getPathResizedSVGProperties([t, e, i, s]) {
    ...
    r[3] = s;
    if (
      Math.abs(h - n) <= Outline.PRECISION ||
      Math.abs(d - a) <= Outline.PRECISION
    ) {
      const n = t + i / 2 - (o + h / 2),
        a = e + s / 2 - (l + d / 2);
      for (const { line: t, points: e } of this.#Pr) {
        Outline._translate(t, n, a, t);
        Outline._translate(e, n, a, e);
      }
      return {
        root: { viewBox: this.viewBox },
        path: {
    ...
    if (1 !== c || 1 !== u || 0 !== p || 0 !== g)
      for (const { line: t, points: e } of this.#Pr) {
        Outline._rescale(t, p, g, c, u, t);
        Outline._rescale(e, p, g, c, u, e);
      }
    return {
      root: { viewBox: this.viewBox },
      path: {
  ...
  getPathTranslatedSVGProperties([t, e], i) {
    const [s, n] = i,
      ...
      r = t - a[0],
      o = e - a[1];
    if (this.#Rr === s && this.#Ir === n)
      for (const { line: t, points: e } of this.#Pr) {
        Outline._translate(t, r, o, t);
        Outline._translate(e, r, o, e);
      }
    else {
      const t = this.#Rr / s,
        e = this.#Ir / n;
      this.#Rr = s;
      this.#Ir = n;
      for (const { line: i, points: s } of this.#Pr) {
        Outline._rescale(i, r, o, t, e, i);
        Outline._rescale(s, r, o, t, e, s);
      }
      a[2] *= t;
      a[3] *= e;
    }
  ...
  get defaultSVGProperties() {
    ...
    return {
      ...
      path: {
        d: this.toSVGPath(),
        "transform-origin": `${Outline.svgRound(t[0])} ${Outline.svgRound(t[1])}`,
        transform: this.rotationTransform || null,
      },
      bbox: t,
    };
...
class InkDrawingOptions extends DrawingOptions {
  ...
  clone() {
    const t = new InkDrawingOptions(this.#zr);
    t.updateAll(this);
    return t;
  }
}
class InkEditor extends DrawingEditor {
  ...
  static initialize(t, e) {
    AnnotationEditor.initialize(t, e);
    this._defaultDrawingOptions = new InkDrawingOptions(e.viewParameters);
  }
  static getDefaultDrawingOptions(t) {
  ...
  static get typesMap() {
    return shadow(
      ...
      "typesMap",
      new Map([
        [m.INK_THICKNESS, "stroke-width"],
        [m.INK_COLOR, "stroke"],
        [m.INK_OPACITY, "stroke-opacity"],
      ]),
    );
  }
  static createDrawerInstance(t, e, i, s, n) {
  ...
  static deserializeDraw(t, e, i, s, n, a) {
    return InkDrawOutline.deserialize(t, e, i, s, n, a);
  }
  static async deserialize(t, e, i) {
    let s = null;
  ...
  onScaleChanging() {
    ...
    e.updateSVGProperty("stroke-width");
    i.drawLayer.updateProperties(t, e.toSVGProperties());
  }
  static onScaleChangingWhenDrawing() {
  ...
  serialize(t = !1) {
    if (this.isEmpty()) return null;
    if (this.deleted) return this.serializeDeleted();
    const { lines: e, points: i, rect: s } = this.serializeDraw(t),
      {
        _drawingOptions: { stroke: n, "stroke-opacity": a, "stroke-width": r },
      } = this,
      o = {
        annotationType: g.INK,
    ...
    if (t) return o;
    if (this.annotationElementId && !this.#$n(o)) return null;
...
class StampEditor extends AnnotationEditor {
  ...
  #to() {
    ...
    if (this.#Vr) {
      ...
      this.#Vr = null;
      this._uiManager.enableWaiting(!0);
      this.#$r = this._uiManager.imageManager
        .getFromUrl(t)
        .then((t) => this.#Qr(t))
        .finally(() => this.#Zr());
      return;
  ...
  #Jr() {
    ...
    this._uiManager.enableWaiting(!1);
    const l = (this.#qr = document.createElement("canvas"));
    ...
    this.#Wr && l.setAttribute("aria-label", this.#Wr);
  }
  copyCanvas(t, e, i = !1) {
    t || (t = 224);
    const { width: s, height: n } = this.#Ur,
      a = new OutputScale();
    let r = this.#Ur,
      o = s,
      l = n,
  ...
  #io(t, e) {
    const { width: i, height: s } = this.#Ur;
    let n = i,
      a = s,
      r = this.#Ur;
    for (; n > 2 * t || a > 2 * e; ) {
  ...
  #eo() {
    ...
    o.width = a;
    o.height = r;
    const l = this.#Kr ? this.#Ur : this.#io(a, r),
      h = o.getContext("2d");
    h.filter = this._uiManager.hcmFilter;
    h.drawImage(l, 0, 0, l.width, l.height, 0, 0, a, r);
  }
  getImageForAltText() {
    return this.#qr;
  }
  #so(t) {
    if (t) {
      if (this.#Kr) {
        const t = this._uiManager.imageManager.getSvgUrl(this.#Gr);
        if (t) return t;
      }
      const t = document.createElement("canvas");
      ({ width: t.width, height: t.height } = this.#Ur);
      t.getContext("2d").drawImage(this.#Ur, 0, 0);
      return t.toDataURL();
    }
    if (this.#Kr) {
      const [t, e] = this.pageDimensions,
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof StampAnnotationElement) {
      ...
      c.remove();
      const p =
        (await e._structTree.getAriaAttributes(`${et}${r}`))?.get(
          "aria-label",
        ) || "";
      s = t = {
  ...
  serialize(t = !1, e = null) {
    ...
    const a = this.#Kr
      ...
      : null;
    if (e.stamps.has(this.#Gr)) {
      if (this.#Kr) {
        const t = e.stamps.get(this.#Gr);
        if (a > t.area) {
          t.area = a;
          t.serialized.bitmap.close();
          t.serialized.bitmap = this.#so(!1);
        }
      }
    } else {
      e.stamps.set(this.#Gr, { area: a, serialized: i });
      i.bitmap = this.#so(!1);
    }
    return i;
  }
...
class AnnotationEditorLayer {
  ...
  static #U = new Map(
    [FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map((t) => [
      t._editorType,
      t,
    ]),
  );
  constructor({
    ...
    const d = [...AnnotationEditorLayer.#U.values()];
  ...
  updateMode(t = this.#m.getMode()) {
    ...
    for (const i of AnnotationEditorLayer.#U.values())
      e.toggle(`${i._type}Editing`, t === i._editorType);
    this.div.hidden = !1;
  }
  hasTextLayer(t) {
    return t === this.#go?.div;
  }
  setEditingState(t) {
  ...
  toggleAnnotationLayerPointerEvents(t = !1) {
    this.#ao?.div.classList.toggle("disabled", !t);
  }
  async enable() {
    this.#co = !0;
    this.div.tabIndex = 0;
    ...
    const e = this.#ao.getEditableAnnotations();
    for (const i of e) {
      i.hide();
  ...
  disable() {
    ...
    if (this.#ao) {
      const i = this.#ao.getEditableAnnotations();
      for (const s of i) {
        const { id: i } = s.data;
    ...
    for (const t of AnnotationEditorLayer.#U.values())
      i.remove(`${t._type}Editing`);
    this.disableTextSelection();
    this.toggleAnnotationLayerPointerEvents(!0);
    this.#do = !1;
  }
  getEditableAnnotation(t) {
    return this.#ao?.getEditableAnnotation(t) || null;
  }
  setActiveEditor(t) {
  ...
  enableTextSelection() {
    ...
    if (this.#go?.div && !this.#mo) {
      ...
      const t = this.#m.combinedSignal(this.#mo);
      this.#go.div.addEventListener("pointerdown", this.#bo.bind(this), {
        signal: t,
      });
  ...
  enableClick() {
    ...
    const t = this.#m.combinedSignal(this.#ro);
  ...
  attach(t) {
    ...
    e &&
      this.#m.isDeletedAnnotationElement(e) &&
      this.#m.removeDeletedAnnotationElement(t);
  }
  detach(t) {
    this.#lo.delete(t.id);
    this.#Cn?.removePointerInTextLayer(t.contentDiv);
    !this.#do &&
      t.annotationElementId &&
      this.#m.addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t);
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#Cn?.moveElementInDOM(
      this.div,
      t.div,
      t.contentDiv,
      !0,
  ...
  get #Ao() {
    return AnnotationEditorLayer.#U.get(this.#m.getMode());
  }
  combinedSignal(t) {
  ...
  pasteEditor(t, e) {
    this.#m.updateToolbar(t);
    this.#m.updateMode(t);
    const { offsetX: i, offsetY: s } = this.#vo(),
      n = this.getNextId(),
      a = this.#wo({
        parent: this,
        id: n,
  ...
  addNewEditor() {
    this.createAndAddNewEditor(this.#vo(), !0);
  }
  setSelected(t) {
  ...
  pointerup(t) {
    ...
    if (
      ...
      this.#ho = !1;
      (this.#Ao?.isDrawer && this.#Ao.supportMultipleDrawings) ||
        (this.#no
  ...
  startDrawingSession(t) {
    this.div.focus();
    if (this.#uo) {
      this.#Ao.startDrawing(this, this.#m, !1, t);
      return;
    }
    this.#m.setCurrentDrawingSession(this);
    this.#uo = new AbortController();
    const e = this.#m.combinedSignal(this.#uo);
    this.div.addEventListener(
      "blur",
      ({ relatedTarget: t }) => {
        if (t && !this.div.contains(t)) {
          this.#po = null;
          this.commitOrRemove();
        }
      },
  ...
  #fo() {
    for (const t of this.#lo.values()) t.isEmpty() && t.remove();
  }
  render({ viewport: t }) {
    this.viewport = t;
  ...
  update({ viewport: t }) {
    ...
    if (e !== i) for (const t of this.#lo.values()) t.rotate(i);
  }
  get pageDimensions() {
...
class DrawLayer {
  ...
  #Eo() {
    const t = DrawLayer._svgFactory.create(1, 1, !0);
    this.#nn.append(t);
  ...
  #Co(t, e) {
    for (const [i, s] of Object.entries(e))
      null === s ? t.removeAttribute(i) : t.setAttribute(i, s);
  }
  draw(t, e = !1, i = !1) {
    const s = this.#w++,
      n = this.#Eo(),
      a = DrawLayer._svgFactory.createElement("defs");
    n.append(a);
    ...
    e && this.#xo.set(s, r);
    const l = i ? this.#So(a, o) : null,
      h = DrawLayer._svgFactory.createElement("use");
    n.append(h);
    h.setAttribute("href", `#${o}`);
    this.updateProperties(n, t);
    this.#yo.set(s, n);
    return { id: s, clipPathId: `url(#${l})` };
  }
  drawOutline(t, e) {
    const i = this.#w++,
      s = this.#Eo(),
      n = DrawLayer._svgFactory.createElement("defs");
    s.append(n);
    ...
    if (e) {
      ...
      n.append(t);
      o = `mask_p${this.pageIndex}_${i}`;
      t.setAttribute("id", o);
      t.setAttribute("maskUnits", "objectBoundingBox");
      const e = DrawLayer._svgFactory.createElement("rect");
      t.append(e);
      e.setAttribute("width", "1");
      e.setAttribute("height", "1");
      e.setAttribute("fill", "white");
      const s = DrawLayer._svgFactory.createElement("use");
      t.append(s);
  ...
  updateProperties(t, e) {
    if (!e) return;
    const { root: i, bbox: s, rootClass: n, path: a } = e,
      r = "number" == typeof t ? this.#yo.get(t) : t;
    if (r) {
      i && this.#Co(r, i);
      s && DrawLayer.#_o(r, s);
      if (n) {
  ...
  remove(t) {
    this.#xo.delete(t);
    if (null !== this.#nn) {
      this.#yo.get(t).remove();
      this.#yo.delete(t);
    }
  }
  destroy() {
    this.#nn = null;
    for (const t of this.#yo.values()) t.remove();
    this.#yo.clear();
    this.#xo.clear();
  }
}
...
var Ut = __webpack_exports__.AbortException,
  Gt = __webpack_exports__.AnnotationEditorLayer,
  $t = __webpack_exports__.AnnotationEditorParamsType,
  Vt = __webpack_exports__.AnnotationEditorType,
  jt = __webpack_exports__.AnnotationEditorUIManager,
  Wt = __webpack_exports__.AnnotationLayer,
  qt = __webpack_exports__.AnnotationMode,
  Xt = __webpack_exports__.ColorPicker,
  Kt = __webpack_exports__.DOMSVGFactory,
  Yt = __webpack_exports__.DrawLayer,
  Qt = __webpack_exports__.FeatureTest,
  Jt = __webpack_exports__.GlobalWorkerOptions,
  Zt = __webpack_exports__.ImageKind,
  te = __webpack_exports__.InvalidPDFException,
  ee = __webpack_exports__.MissingPDFException,
  ie = __webpack_exports__.OPS,
  se = __webpack_exports__.OutputScale,
  ne = __webpack_exports__.PDFDataRangeTransport,
  ae = __webpack_exports__.PDFDateString,
  re = __webpack_exports__.PDFWorker,
  oe = __webpack_exports__.PasswordResponses,
  le = __webpack_exports__.PermissionFlag,
  he = __webpack_exports__.PixelsPerInch,
  de = __webpack_exports__.RenderingCancelledException,
  ce = __webpack_exports__.TextLayer,
  ue = __webpack_exports__.TouchManager,
  pe = __webpack_exports__.UnexpectedResponseException,
  ge = __webpack_exports__.Util,
  me = __webpack_exports__.VerbosityLevel,
  fe = __webpack_exports__.XfaLayer,
  be = __webpack_exports__.build,
  Ae = __webpack_exports__.createValidAbsoluteUrl,
  we = __webpack_exports__.fetchData,
  ve = __webpack_exports__.getDocument,
  ye = __webpack_exports__.getFilenameFromUrl,
  xe = __webpack_exports__.getPdfFilenameFromUrl,
  _e = __webpack_exports__.getXfaPageViewport,
  Ee = __webpack_exports__.isDataScheme,
  Se = __webpack_exports__.isPdfFile,
  Ce = __webpack_exports__.noContextMenu,
  Te = __webpack_exports__.normalizeUnicode,
  Me = __webpack_exports__.setLayerDimensions,
  Pe = __webpack_exports__.shadow,
  De = __webpack_exports__.stopEvent,
  ke = __webpack_exports__.version;
export {
  Ut as AbortException,
  Gt as AnnotationEditorLayer,
  $t as AnnotationEditorParamsType,
  Vt as AnnotationEditorType,
  jt as AnnotationEditorUIManager,
  Wt as AnnotationLayer,
  qt as AnnotationMode,
  Xt as ColorPicker,
  Kt as DOMSVGFactory,
  Yt as DrawLayer,
  Qt as FeatureTest,
  Jt as GlobalWorkerOptions,
  Zt as ImageKind,
  te as InvalidPDFException,
  ee as MissingPDFException,
  ie as OPS,
  se as OutputScale,
  ne as PDFDataRangeTransport,
  ae as PDFDateString,
  re as PDFWorker,
  oe as PasswordResponses,
  le as PermissionFlag,
  he as PixelsPerInch,
  de as RenderingCancelledException,
  ce as TextLayer,
  ue as TouchManager,
  pe as UnexpectedResponseException,
  ge as Util,
  me as VerbosityLevel,
  fe as XfaLayer,
  be as build,
  Ae as createValidAbsoluteUrl,
  we as fetchData,
  ve as getDocument,
  ye as getFilenameFromUrl,
  xe as getPdfFilenameFromUrl,
  _e as getXfaPageViewport,
  Ee as isDataScheme,
  Se as isPdfFile,
  Ce as noContextMenu,
  Te as normalizeUnicode,
  Me as setLayerDimensions,
  Pe as shadow,
  De as stopEvent,
  ke as version,
};
